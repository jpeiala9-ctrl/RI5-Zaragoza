// ==================== profile.js ====================
// Versión: 11.2 - CORREGIDO: Prevención de toasts duplicados
//                 - Se usa un timeout para evitar múltiples ejecuciones
//                 - Cada función tiene un flag de ejecución
// ====================
...
const Profile = {
  ...
  async _mostrarLikesDeEntrenamiento(entryId) {
    ...
    // Limpiar timeout de toasts anteriores
    ...
    try {
      ...
      if (likes.length === 0) {
        // Mostrar UN SOLO toast y bloquear más durante 1 segundo
...
console.log('✅ profile.js v11.2 - Prevención de toasts duplicados');