// ==================== profile.js ====================
// Versión: 10.8 - Mini-mapa Leaflet real (igual que el Muro) en "Mis últimos entrenamientos"
// ====================
...
const Profile = {
  ...
  _vincularToqueEntrada(entryId, entry) {
    ...
    if (mapContainer && !mapContainer.dataset.mapCreated) {
...
console.log('✅ profile.js v10.8 - Mini-mapa Leaflet real en "Mis últimos entrenamientos"');