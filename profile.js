// ==================== profile.js - PERFIL CON ZAPATILLA ACTUAL Y SIN RACHA ====================
// Versión: 6.0 - Eliminada racha actual, añadida zapatilla con acumulación de km.
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ========== GAMIFICACIÓN (SIN RACHA, CON ZAPATILLA) ==========
      try {
        ...
        if (gamificationData) {
          ...
          // Obtener datos de la zapatilla actual
      ...
      // Eventos de colapso, likes y cambio de zapatilla
      setTimeout(() => {
        ...
        if (changeBtn) {
          changeBtn.onclick = async () => {
            ...
            if (newName && newName.trim()) {
              ...
              await Profile.cargarPerfil(); // recargar para mostrar el nuevo nombre
