...
const Profile = {
  ...
  _renderRecordsContenido(gamificationData) {
      ...
      return `
        ...
        ${filasRecord}
        <p style="text-align:center; font-size:10px; color:var(--text-secondary); margin-top:14px;">Con GPS, cualquier tramo de tu recorrido que iguale esa distancia cuenta como intento (aunque sea parte de una carrera más larga). Sin GPS, cuenta si corres al menos esa distancia, con el tiempo calculado a tu ritmo medio exacto para esa distancia.</p>
      `;
  },
