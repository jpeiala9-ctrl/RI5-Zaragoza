// ==================== profile.js - PERFIL CON NIVEL POR KM Y COLOR SEGÚN NIVEL (DIAMANTE NIVEL 10) ====================
// Versión: 4.9 - Color diamante para nivel 10
// ====================
    ...
    try {
      ...
      try {
        ...
        if (gamificationData) {
          ...
          // Para el texto, usamos el color directamente
