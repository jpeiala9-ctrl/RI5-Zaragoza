...
// Versión: 2.0 - Diseño mejorado: recuadros iguales y texto legible
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // Usamos un grid con 3 columnas para que todos los recuadros sean iguales
      let html = `
        ...
        <div class="perfil-detalle-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin: 20px 0;">
