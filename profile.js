// ==================== profile.js - PERFIL CON MINI MURO PERSONAL ====================
// Versión: 5.0 - Añadida sección "MIS ÚLTIMOS ENTRENAMIENTOS" desde globalFeed
// ====================
    ...
    try {
      ...
      try {
        ...
        if (!misEntrenamientosSnapshot.empty) {
          ...
          misEntrenamientosSnapshot.forEach(doc => {
            ...
            entrenamientosHTML += `
              <div class="mis-entreno-item" style="border-bottom:1px solid var(--border-color); padding:12px 0; display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between;">
        ...
        // Si falla, no mostramos nada, pero no rompemos el perfil.
      }
      // ============================================================
