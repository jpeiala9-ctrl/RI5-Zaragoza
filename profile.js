...
// Versión: 10.2 - Limpieza de caché al forzar recarga
// MODIFICADO: muestra distancia/tiempo real del GPS, minimapa con fondo claro
// ====================

const Profile = {
  _gpsEntries: {}, // cache de entries GPS para el viewer

  // *** NUEVA FUNCIÓN: minimapa con fondo claro ***
      ...
      try {
        ...
        if (!misEntrenamientosSnapshot.empty) {
          ...
          for (const doc of misEntrenamientosSnapshot.docs) {
            ...
            // *** MODIFICACIÓN: priorizar datos GPS reales ***
