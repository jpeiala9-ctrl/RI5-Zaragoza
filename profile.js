...
// Versión: 2.8 - Corregido uso de profile.age en lugar de birthDate
// ====================
  ...
  async cargarPerfil() {
    ...
    try {
      ...
      if (friendIds.length !== currentCount) {
        // Actualizar en Firestore sin esperar (no bloquear la UI)
        ...
        // Corregir localmente para esta sesión
