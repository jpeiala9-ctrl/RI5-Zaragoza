// ==================== profile.js - Gestión de perfil de usuario (EMAIL CENTRADO) ====================
// Versión: 4.1 - Email centrado en el grid del perfil
// ====================
    ...
    try {
      ...
      let html = `
        ...
        <div class="perfil-detalle-grid">
          ...
          <div class="perfil-detalle-item" style="grid-column: span 3; text-align: center;">
