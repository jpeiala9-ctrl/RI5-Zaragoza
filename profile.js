// ==================== profile.js - PERFIL CON OPTIMIZACIÓN (CACHÉ Y LOTES) ====================
// Versión: 5.7 - Caché de 1 minuto, limpieza de amigos con lotes '__name__'
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    // Mostrar caché si existe (válido por 1 minuto)
    if (cached) {
      try {
    ...
    try {
      ...
      // Eventos de colapso y modal de likes
      setTimeout(() => {
