// ==================== profile.js ====================
// Versión: 14.0 - COPIA EXACTA DE WALL.JS
//                 - NADA inventado, NADA añadido
//                 - La lógica de mapas es IDÉNTICA a wall.js
// ====================
...
const Profile = {
  ...
  async cargarPerfil(forceRefresh = true) {
    ...
    try {
      ...
      // ================================================================
      //  MIS ÚLTIMOS ENTRENAMIENTOS - COPIA EXACTA DE WALL.JS
      // ================================================================
      ...
      try {
        ...
        if (!misEntrenamientosSnapshot.empty) {
          ...
          for (const doc of misEntrenamientosSnapshot.docs) {
            ...
            //  - NADA más, sin overlay, sin onclick, sin nada
            // ============================================================
            let miniMapHTML = '';
      ...
      //  - CON UN TIMEOUT PARA ASEGURAR QUE EL DOM ESTÁ LISTO
      // ================================================================
      setTimeout(() => {
  ...
  //  - IDÉNTICO, sin ninguna modificación
  // ================================================================
...
console.log('✅ profile.js v14.0 - COPIA EXACTA de wall.js, sin inventar nada');