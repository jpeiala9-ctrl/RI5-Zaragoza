// ==================== profile.js - PERFIL CON TARJETA DE NIVEL MÁS LIMPIA ====================
// Versión: 6.5 - Segunda línea simplificada: km total y zapatilla. Tercera línea: sesiones y XP.
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ========== GAMIFICACIÓN CON DISEÑO MÁS LIMPIO ==========
      try {
        ...
        if (gamificationData) {
          ...
          html += `
            <div class="gamification-section" style="margin-top:24px; padding:16px; background: ${bgColor}; border-radius:20px; transition: background 0.3s; text-align:center;">
              ...
              <!-- Fila 1: km total y zapatilla (dos columnas) -->
              <div style="display: flex; justify-content: space-around; align-items: center; gap: 12px; margin-bottom: 12px;">
                <div>
                ...
                <div>
                  ...
                  <span style="font-size:11px;">${shoeKm} km</span>
                </div>
              </div>
              
              <!-- Fila 2: sesiones y XP (dos columnas) -->
              ...
              <!-- Botón cambiar zapatilla centrado -->
