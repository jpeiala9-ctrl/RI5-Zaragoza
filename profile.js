// ==================== profile.js - CONTADOR DE AMIGOS REAL + GAMIFICACIÓN ====================
// Versión: 4.6 - Añadida sección de gamificación (nivel, XP, racha, insignias)
// ====================
  ...
  async cargarPerfil() {
    ...
    try {
      ...
      try {
        ...
        if (gamificationData) {
          const progress = Gamification.getProgressToNextLevel(gamificationData.totalXP);
          ...
          html += `
            <div class="gamification-section" style="margin-top:24px; padding:16px; background:var(--bg-secondary); border-radius:16px;">
              <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                <div>
                  <strong style="font-size:20px; color:var(--accent-yellow);">Nivel ${gamificationData.level}</strong>
                  <div style="font-size:12px;">XP: ${gamificationData.totalXP}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span style="font-size:12px;">📏 Distancia: ${gamificationData.totalDistance.toFixed(1)} km</span>
                </div>
              </div>
