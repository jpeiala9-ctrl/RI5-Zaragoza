// ==================== profile.js - COMPRESIÓN AUTOMÁTICA: 1920x1920 y <5 MB ====================
// Versión: 9.8 - Redimensiona a 1920x1920 y comprime hasta <5 MB.
// ====================
...
const Profile = {
  ...
  // ==================== MÉTODOS DE EDICIÓN DE PERFIL (MEJORADOS) ====================
  abrirModal() {
  ...
  async seleccionarFoto() {
    ...
    input.onchange = async (e) => {
      ...
      Utils.showLoading();
      try {
        // Comprimir imagen: redimensionar a 1920x1920 y comprimir hasta <5 MB
  ...
  // Comprime la imagen: primero redimensiona a maxDimension (manteniendo proporción), 
  // luego reduce calidad iterativamente hasta que el tamaño sea <= maxSizeBytes.
    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = (e) => {
        ...
        img.onload = async () => {
          ...
          // Último recurso: reducir resolución a 1600px y calidad 0.7
  ...
  // Redimensiona la imagen a un lado máximo (maxDimension), manteniendo proporción
  ...
  // Método legacy (se mantiene por si se llama desde algún sitio)
  compressImage(file) {
