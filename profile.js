// ==================== profile.js - TARJETA "PASAPORTE DEL RUNNING" (CORREGIDA) ====================
// Versión: 9.1 - Corregido error de referencia a LEVELS_KM. Ahora usa Gamification.LEVELS_KM.
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ========== TARJETA "PASAPORTE DEL RUNNING" (CORREGIDA) ==========
      try {
