// ==================== profile.js - TARJETA CON "RANGO" EN VEZ DE "NIVEL" ====================
// Versión: 8.1 - Cambio de etiqueta "NIVEL" a "RANGO". Personalizable.
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ========== GAMIFICACIÓN: "RANGO" en lugar de "NIVEL" ==========
      try {
        ...
        if (gamificationData) {
          ...
          html += `
            <div class="gamification-section" style="margin-top:24px; padding:16px; background: ${bgColor}; border-radius:20px;">
              <!-- Fila 1: RANGO (izquierda) y Zapatilla (derecha) -->
