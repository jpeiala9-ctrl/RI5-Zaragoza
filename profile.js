// ==================== profile.js - PERFIL CON NIVEL POR KM Y COLOR SEGÚN NIVEL ====================
// Versión: 4.8 - Añadido color dinámico al nivel
// ====================
    ...
    try {
      ...
      try {
        ...
        if (gamificationData) {
          ...
          const levelStyle = typeof levelColor === 'string' && levelColor.includes('linear-gradient') 
            ? `background: ${levelColor}; -webkit-background-clip: text; background-clip: text; color: transparent; display: inline-block;`
            : `color: ${levelColor};`;
          ...
          html += `
            <div class="gamification-section" style="margin-top:24px; padding:16px; background:var(--bg-secondary); border-radius:16px;">
              <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                <div>
                  <strong style="font-size:20px; ${levelStyle}">Nivel ${gamificationData.level}</strong>
              ...
              <div class="level-progress" style="margin-top:12px;">
                <div class="level-progress-fill" style="width: ${progress}%; background: ${typeof levelColor === 'string' && !levelColor.includes('linear-gradient') ? levelColor : 'var(--accent-blue)'};"></div>
              </div>
