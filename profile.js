// ==================== profile.js - TARJETA CON MODAL DE INSIGNIAS Y GPS EN ENTRENAMIENTOS ====================
// Versión: 10.4 - Añadido soporte para mostrar mapas GPS con centrado mejorado
// ====================
...
const Profile = {
  ...
  // ========== FUNCIÓN PARA INICIALIZAR MAPAS EN EL PERFIL ==========
      ...
      try {
        ...
        if (doc.exists && doc.data().gpsRoute) {
          ...
          if (gpsRoute.points && gpsRoute.points.length >= 2) {
            // Usamos la función displayRoute mejorada de GPSTracker (con centrado)
