// ==================== profile.js - CONTADOR DE AMIGOS REAL (SIN FANTASMAS) ====================
// Versión: 4.5 - Limpia amigos huérfanos y muestra la cantidad exacta
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // Ahora el contador real es la longitud del array limpio
