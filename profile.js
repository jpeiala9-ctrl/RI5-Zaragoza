// ==================== profile.js - CONTADOR DE AMIGOS REAL + GAMIFICACIÓN (NIVEL POR KM) ====================
// Versión: 4.7 - El nivel se calcula según kilómetros totales (no XP)
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ==================== GAMIFICATION (basada en kilómetros) ====================
      try {
        const gamificationData = await Gamification.getData(AppState.currentUserId);
        if (gamificationData) {
          // Usar distancia total para calcular progreso (NO XP)
