...
// Versión: 5.2 - Entrenamientos colapsables + modal de likes al hacer clic en el corazón
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      setTimeout(() => {
        // 1. Evento de colapso: al hacer clic en la cabecera, mostrar/ocultar el detalle
        ...
        // 2. Evento de like: al hacer clic en el corazón, mostrar modal de likes (sin dar like)
  ...
  async _showLikesModal(e) {
    ...
    try {
      // Reutilizar la función del muro global si existe
      if (typeof Wall !== 'undefined' && Wall.showLikesModal) {
        await Wall.showLikesModal(entryId);
      } else {
        // Implementación propia si Wall no está disponible
  ...
  // Crea y muestra el modal de likes (copia de Wall._createLikesModal pero adaptada)
  ...
  // El resto de métodos (abrirModal, cerrarModal, cargarDatosEnModal, etc.) se mantienen exactamente igual que en la versión anterior
  abrirModal() {
