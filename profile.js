...
// Versión: 3.7 - CORREGIDO: El contador de amigos simplemente replica el número de la pestaña social
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      // ========== SOLUCIÓN SIMPLE: OBTENER AMIGOS DIRECTAMENTE DE LA MISMA FUENTE QUE LA PESTAÑA SOCIAL ==========
      let numeroAmigos = 0;
      try {
        const amigos = await Storage.getFriends(AppState.currentUserId);
        numeroAmigos = amigos.length;
      } catch (e) {
        console.warn('Error obteniendo amigos:', e);
        numeroAmigos = 0;
      }
        ...
        <div class="perfil-header">
          ...
          <div class="perfil-info">
            ...
            <div class="perfil-stats">
              <div class="perfil-stat"><span>${numeroAmigos}</span><label>Amigos</label></div>
