// ==================== profile.js - Gestión de perfil de usuario (EMAIL CENTRADO Y SIMÉTRICO) ====================
// Versión: 4.2 - Corrección de simetría en el grid del perfil
// ====================
...
const Profile = {
  async cargarPerfil() {
    ...
    try {
      ...
      const height = profile.height ? Utils.escapeHTML(profile.height + ' m') : '—'; // Ajuste visual: metros con 2 decimales, pero aquí mostramos lo que venga
      ...
      let html = `
        ...
        <div class="perfil-detalle-grid">
          ...
          <div class="perfil-detalle-item" style="grid-column: span 3;">
