// ==================== profile.js - TARJETA "PASAPORTE" MODIFICADA: NOMBRE CENTRADO, BOTONES MÁS PEQUEÑOS ====================
// Versión: 9.2 - Cabecera con nombre de usuario, "Nivel" centrado, botones compactos.
// ====================
    ...
    try {
      ...
      try {
        ...
        if (gamificationData) {
          ...
          // Nombre del usuario para la cabecera
          ...
          html += `
            <div class="passport-card" style="margin-top:24px; border:2px solid ${levelColor}; border-radius:24px; background:${bgColor}; box-shadow:0 8px 20px rgba(0,0,0,0.1); overflow:hidden;">
              <!-- Cabecera: nombre del usuario centrado -->
              <div style="padding:16px 20px 0 20px; text-align:center; border-bottom:1px solid ${levelColor}40;">
                <span style="font-size:16px; font-weight:500; letter-spacing:1px;">${Utils.escapeHTML(userName)}</span>
              </div>
              ...
              <div style="padding:16px 20px;">
                ...
                <div style="display: flex; justify-content: center; gap: 12px; margin-top:8px;">
                  <button id="changeShoeBtn" style="background:transparent; border:1px solid ${levelColor}; color:${levelColor}; padding:4px 12px; border-radius:40px; font-size:10px; letter-spacing:0.5px; cursor:pointer; transition:all 0.2s;">👟 Cambiar</button>
                  <button id="historyShoeBtn" style="background:transparent; border:1px solid ${levelColor}; color:${levelColor}; padding:4px 12px; border-radius:40px; font-size:10px; letter-spacing:0.5px; cursor:pointer; transition:all 0.2s;">📜 Historial</button>
                </div>
              </div>
            </div>
          `;
