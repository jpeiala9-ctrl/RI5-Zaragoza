// ==================== profile.js - TARJETA CON RANGO CENTRADO Y ZAPATILLA CENTRADA ====================
// Versión: 8.2 - Corregida la alineación del número de rango (centrado).
// ====================
        ...
        if (gamificationData) {
          ...
          html += `
            <div class="gamification-section" style="margin-top:24px; padding:16px; background: ${bgColor}; border-radius:20px;">
              <!-- Fila 1: RANGO (centrado) y Zapatilla (centrado) -->
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <div style="flex:1; text-align: center;">
                  <div style="font-size:10px; letter-spacing:1px; text-transform:uppercase; color:var(--text-secondary);">RANGO</div>
