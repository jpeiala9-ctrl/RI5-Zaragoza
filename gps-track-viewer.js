// ==================== gps-track-viewer.js ====================
// Versión: 2.7 - FIX: Mapa se abre una sola vez, sin parpadeos
//                - Precarga de Leaflet ANTES de abrir el modal
//                - Track visible sobre el mapa de calles
// ====================
...
const GPSTrackViewer = {
  ...
  async open(entry) {
    ...
    // Prevenir aperturas múltiples simultáneas
    if (this._isOpening) {
      console.log('⏳ Visor GPS ya abriéndose, ignorando...');
      return;
    }
...
console.log('✅ GPSTrackViewer v2.7 - Mapa sin parpadeos, track visible');