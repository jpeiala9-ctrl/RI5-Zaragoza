...
const GPSTrackViewer = {
  ...
  _crearModal(entry, ciudad) {
    ...
    modal.innerHTML = `
      ...
      <div id="gpsViewerMap" style="height:300px; background:var(--stat-bg);"></div>
...
console.log('✅ GPSTrackViewer v2.8 - Botón CERRAR unificado (action-button) + arreglo de parpadeo al abrir');
