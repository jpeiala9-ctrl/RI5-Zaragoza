...
const GPSTrackViewer = {
  ...
  async _initMap(entry) {
    ...
    try {
      ...
      // cuenta ni clave.
      // 🔥 v2: igual que en gps-tracker.js -- Esri "Light Gray Canvas" en
      // vez de los tiles estándar de OSM, que son mucho más recargados
      // (nombres de calle, colores por uso de suelo) y no se parecían al
      // estilo limpio de CartoDB "light_all" de antes. Trade-off: hasta
      // zoom 16, no 19.
