// ==================== chat.js - Mensajería entre amigos (CON HORA EN MENSAJES) ====================
// Versión: 1.9 - Muestra hora de cada mensaje
// ====================
...
const Chat = {
  ...
  // ========== FUNCIÓN MODIFICADA: MUESTRA HORA DEL MENSAJE ==========
  appendMessage(msg, otherUserId) {
    ...
    // Opcional: mostrar fecha si es diferente al día actual
    const today = new Date();
    const isDifferentDay = timestamp.toDateString() !== today.toDateString();
    if (isDifferentDay) {
      const day = timestamp.getDate().toString().padStart(2, '0');
      const month = (timestamp.getMonth() + 1).toString().padStart(2, '0');
      formattedTime = `${day}/${month} ${formattedTime}`;
    }
