// ==================== chat.js - Chat estilo Telegram (con separadores de fecha, hora, palomitas) ====================
// Versión final: agrupación por fecha (Hoy, Ayer, o fecha larga), hora en cada mensaje, ✓ (enviado) y ✓✓ (visto)
// Los colores se adaptan mediante variables CSS (modifica :root en tus estilos)
// ====================
...
// Quitar el color verde del item en la lista de conversaciones inmediatamente
const convItem = document.querySelector(`.conversacion-item[data-conv-id="${conversationId}"]`);
if (convItem) {
convItem.classList.remove(‘conversacion-no-leida’);
const nombreEl = convItem.querySelector(’.conversacion-nombre’);
if (nombreEl) nombreEl.classList.remove(‘conversacion-nombre-no-leido’);
const badge = convItem.querySelector(’.conversacion-badge’);
...
// Actualizar badges y colores tras leer los mensajes
