// ==================== chat.js - Mensajería entre amigos (CON ELIMINACIÓN AUTOMÁTICA DEL MODAL) ====================
// Versión: 2.1 - Al eliminar conversación se cierra el modal automáticamente
// ====================
...
const Chat = {
  ...
  async deleteConversation(conversationId) {
    ...
    try {
      ...
      // Cerrar el modal si la conversación eliminada es la actual
      if (this.currentConversationId === conversationId) {
        this.closeChat();
      }

      // Refrescar lista de amigos (donde se muestran las conversaciones)
  ...
  openChat(conversationId, otherUserId, otherUsername) {
    ...
    if (!modal) {
      ...
      // Evento eliminar: no necesita cerrar manualmente porque deleteConversation ya lo hace
      ...
      // Si el modal ya existe, actualizar evento del botón eliminar
