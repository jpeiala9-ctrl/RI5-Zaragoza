// ==================== CHAT.JS - CIERRE LIMPIA NOTIFICACIONES ====================
<script>
  const Chat = {
    ...
    // ✅ CORREGIDO: Al cerrar el chat, se marcan como leídos y desaparecen notificaciones
    closeChat() {
      ...
      // ✅ NUEVO: Al cerrar el chat, marcar mensajes como leídos y limpiar notificaciones
      if (this.currentConversationId) {
