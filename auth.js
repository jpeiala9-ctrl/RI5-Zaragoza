...
// Versión: 4.4 - Bloqueo ultra-estricto con logs visibles
// ====================
...
const Auth = {
  ...
  async registerUser() {
    ...
    try {
      ...
      // IMPORTANTE: No llamamos a setCurrentUser ni mostramos mainContent.
      // Directamente mostramos la pantalla de verificación.
