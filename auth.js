...
// Versión: 5.1 - Corrección de mensajes de error: sin detalles técnicos
// ====================
...
const Auth = {
  ...
  _manejarErrorFirebase(error) {
    // Si el error tiene un código conocido, lo mapeamos a un mensaje amigable
    switch (error?.code) {
      ...
      default:
        // Para cualquier otro error (incluidos JSON raros) mostramos un mensaje genérico
