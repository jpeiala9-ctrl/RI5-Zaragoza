...
// Versión: 5.11 - Transición con fade-in y fondo visible (sin pantalla negra)
// ====================
...
const Auth = {
  ...
  async verificarAhora() {
    ...
    try {
      ...
      if (user.emailVerified) {
        ...
        document.getElementById("mainContent").style.transition = "opacity 0.4s ease";
  ...
  async loginUser() {
    ...
    try {
      ...
      // === TRANSICIÓN SUAVE: mainContent siempre visible pero con opacidad 0 ===
      document.getElementById("loginPage").style.display = "none";
      document.getElementById("verificationPage").style.display = "none";
      ...
      mainContent.style.backgroundColor = "var(--bg-primary)"; // Evita que se vea el negro del body
  ...
  async checkSavedSession() {
    ...
    try {
      ...
      // Transición suave para sesión guardada
      document.getElementById("loginPage").style.display = "none";
      document.getElementById("verificationPage").style.display = "none";
