...
// Versión: 3.9 - Corrección de persistencia offline y manejo de errores de Firestore
// ====================
...
const Auth = {
  ...
  async registerUser() {
    ...
    try {
      ...
      // 5. Crear el documento del usuario en users
      ...
      // 8. Intentar habilitar persistencia offline después del registro
