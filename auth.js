...
// Versión: 5.9 - Botón de login con animación de latido (sin overlay de carga)
// ====================
...
const Auth = {
  ...
  async loginUser() {
    ...
    // 🔥 ANIMACIÓN DEL BOTÓN: latido y cambio de texto
    btn.disabled = true;
    ...
    try {
      ...
      // Ocultar login y mostrar app (sin overlay)
      document.getElementById("loginPage").style.display = "none";
      document.getElementById("verificationPage").style.display = "none";
      document.getElementById("mainContent").style.visibility = "hidden";
      document.getElementById("mainContent").style.display = "flex";
      ...
      // Restaurar el botón antes de mostrar la app
      btn.disabled = false;
      btn.textContent = '[ ACCEDER ]';
      btn.classList.remove('pulse');
