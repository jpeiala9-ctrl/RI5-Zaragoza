...
// Versión: 3.4 - CORREGIDA (restauración de últimas zonas)
// 
// Cambios:
// - Al hacer login, se muestran las últimas zonas con Training.mostrarResultadosGuardados(calc)
// - Al restaurar sesión automática, también se llama a Training.mostrarResultadosGuardados(calc)
