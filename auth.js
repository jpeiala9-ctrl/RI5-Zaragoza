// ==================== auth.js - VERSIÓN FINAL (SOLICITUD DE ELIMINACIÓN INTERNA) ====================
// Registro, login, persistencia y solicitud de eliminación de cuenta (mensaje interno al administrador)
// ====================
...
const Auth = {
  ...
  // ==================== SOLICITUD DE ELIMINACIÓN (MENSAJE INTERNO AL ADMIN) ====================
  async eliminarMiCuenta() {
    ...
    try {
      ...
      if (error.code === 'auth/wrong-password') {
        ...
        Utils.showToast('❌ Error de verificación. Vuelve a intentarlo.', 'error');
      }
      return;
    }
    ...
    try {
      ...
      // Crear la solicitud en la colección 'solicitudesEliminacion' (el administrador leerá esta colección)
