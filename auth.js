...
const Auth = {
  ...
  async registerUser() {
    ...
    // dorado, así que se usa var(--bg-primary) en vez de la paleta de
    // niveles + dorado para que las letras se vean bien en los dos temas.
  ...
  async loginUser() {
    ...
    // Este botón (.button-main) tiene fondo dorado (var(--gold)), así que
    // se le pasa como paleta el mismo color que usa normalmente su texto
    // (var(--bg-primary)) en vez de la paleta de niveles + dorado: si no,
    // tanto las letras de paso como el dorado final quedaban invisibles
    // sobre el propio fondo dorado del botón, en modo claro y oscuro.
