// ==================== auth.js - VERSIÓN DEFINITIVA (ELIMINACIÓN DE CUENTA SIN SESIÓN PREVIA) ====================
// Versión: 3.19 - Elimina cuenta incluso si la sesión está cerrada (solo con email y contraseña)
// ====================
...
const Auth = {
  ...
  async eliminarMiCuenta() {
    ...
    try {
      ...
      if (!currentUser) {
        // No hay sesión activa, iniciamos sesión directamente
        ...
        // La sesión activa es de otro usuario, cerramos sesión y volvemos a iniciar con el correcto
      ...
      try {
        ...
        if (reauthError.code === 'auth/requires-recent-login') {
          // Forzar un nuevo inicio de sesión para refrescar el token
