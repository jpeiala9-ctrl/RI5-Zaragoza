...
// Versión: 3.25 - Totalmente funcional, con reautenticación usando firebase.auth.EmailAuthProvider
// ====================
...
const Auth = {
  ...
  async _reauthenticateUser(password) {
    ...
    // CORRECCIÓN DEFINITIVA: usar el objeto global firebase.auth (no firebaseServices.auth)
