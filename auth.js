...
// Versión: 3.16 - Corregida eliminación de cuenta con verificación de email y reautenticación
// ====================
  ...
  _manejarErrorFirebase(error) {
    switch (error.code) {
      ...
      case 'auth/requires-recent-login':
        return '⚠️ Por seguridad, debes volver a iniciar sesión antes de eliminar la cuenta. Cierra sesión y vuelve a entrar.';
