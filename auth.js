...
// Versión: 3.14 - Mejora en eliminación de cuenta con reautenticación y prevención de cuentas huérfanas
// MODIFICADO: La eliminación ahora envía solicitud interna al administrador (no borra automáticamente)
// ====================
...
const Auth = {
  ...
  // Nueva función: reautenticación con contraseña (corregido EmailAuthProvider)
  ...
  // ==================== SOLICITUD DE ELIMINACIÓN DE CUENTA (mensaje interno al administrador) ====================
  async eliminarMiCuenta() {
    ...
    try {
      ...
      // Enviar solicitud al administrador usando la colección 'mensajes' (documento fijo 'admin_solicitudes')
      ...
      // Añadir al array de mensajes (sin sobrescribir)
      ...
      if (error.code === 'auth/wrong-password') {
        ...
        userMessage = '⚠️ Por seguridad, debes volver a iniciar sesión antes de solicitar la eliminación. Cierra sesión y vuelve a entrar.';
