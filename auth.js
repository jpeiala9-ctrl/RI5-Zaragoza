...
// Versión: 5.12 - Transición inmediata, sin pantalla negra ni opacidades
// ====================
...
const Auth = {
  ...
  async verificarAhora() {
    ...
    try {
      ...
      if (user.emailVerified) {
        ...
        document.getElementById("verificationPage").style.display = "none";
        // Transición inmediata: solo mostrar la app
  ...
  async loginUser() {
    ...
    try {
      ...
      // Eliminar cualquier opacidad o transición que pudiera causar parpadeo
      ...
      // No esperamos a que terminen las promesas para mostrar la app
