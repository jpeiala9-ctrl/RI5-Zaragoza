...
// Versión: 5.5 - Permitir Ñ y acentos en el nombre de usuario + normalización para búsqueda
// ====================
...
const Auth = {
  ...
  // Función auxiliar para normalizar un string (eliminar acentos y convertir ñ a n)
  ...
  async createUserDocument(userId, email, username, extraData = {}) {
    ...
    const userData = {
      username,
      username_lowercase: this._normalizeString(username), // Normalizado sin acentos y con ñ→n
      email,
    ...
    // ==================== GAMIFICATION: inicializar documento de gamificación ====================
    try {
  ...
  async registerUser() {
    ...
    // === CORRECCIÓN: Permitir letras con Ñ, acentos, números y guión bajo ===
    // Se usa una regex unicode (con la bandera 'u') que acepta cualquier letra (incluyendo ñ, á, é, etc.) y números
