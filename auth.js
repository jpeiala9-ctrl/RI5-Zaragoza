...
// Versión: 5.10 - Transición suave, sin pantalla negra
// ====================
...
const Auth = {
  ...
  async verificarAhora() {
    ...
    try {
      ...
      if (user.emailVerified) {
        ...
        document.getElementById("verificationPage").style.display = "none";
        // Transición suave: mainContent aparece sin fondo negro
        document.getElementById("mainContent").style.visibility = "hidden";
        document.getElementById("mainContent").style.display = "flex";
        document.getElementById("mainContent").style.opacity = "0";
        document.getElementById("mainContent").style.transition = "opacity 0.3s ease";
  ...
  async loginUser() {
    ...
    try {
      ...
      // === TRANSICIÓN SUAVE: SIN PANTALLA NEGRA ===
      // Ocultar login y mostrar mainContent pero invisible
      document.getElementById("loginPage").style.display = "none";
      document.getElementById("verificationPage").style.display = "none";
