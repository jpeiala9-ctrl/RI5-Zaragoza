...
// Versión: 4.1 - Corrección completa del flujo de verificación
// ====================
...
const Auth = {
  ...
  async verificarAhora() {
    ...
    Utils.showLoading();
    try {
      await user.reload(); // Recargar datos desde Firebase
      ...
      if (user.emailVerified) {
        ...
        // Cargar datos del usuario y entrar a la app
...
// Este listener detecta automáticamente cuando el usuario verifica su correo
// desde el enlace y lo redirige a la app principal sin necesidad de intervención.
