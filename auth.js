...
// Versión: 3.15 - Corrección de registro con fallback premium y logs detallados
// ====================
...
const Auth = {
  ...
  async createUserDocument(userId, email, username, extraData = {}, isRetry = false) {
    ...
    // Si es reintento, forzamos premium: false para evitar error de reglas
    ...
    // Si creamos con premium false pero queremos premium true, actualizamos después
    if (isRetry) {
      ...
      userData.premium = true; // para devolver el dato correcto
    }
  ...
  async registerUser() {
    ...
    try {
      ...
      // Reservar username
      console.log('📝 Reservando username en colección usernames...');
      ...
      // Mostrar error detallado en consola y en alert para depuración
