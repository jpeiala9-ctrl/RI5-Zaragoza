...
const Training = {
  ...
  abrirEdicionZona(index) {
    ...
    modal.innerHTML = `
      ...
      <input id="editarZonaFcMin" type="number" inputmode="numeric" value="${minActual}" style="width:100%; box-sizing:border-box; padding:10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); margin-bottom:12px; font-size:14px;">
      ${!esZ6 ? `
        <label style="display:block; font-size:11px; color:var(--text-secondary); margin-bottom:4px;">FC máxima (lpm)</label>
        <input id="editarZonaFcMax" type="number" inputmode="numeric" value="${maxActual}" style="width:100%; box-sizing:border-box; padding:10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); margin-bottom:12px; font-size:14px;">
      ` : ''}
      <label style="display:block; font-size:11px; color:var(--text-secondary); margin-bottom:4px;">Ritmo (min/km, formato M:SS)</label>
      <input id="editarZonaPace" type="text" inputmode="numeric" value="${paceActual}" placeholder="5:30" style="width:100%; box-sizing:border-box; padding:10px; border-radius:8px; border:1px solid var(--border-color); background:var(--bg-primary); color:var(--text-primary); margin-bottom:18px; font-size:14px;">
