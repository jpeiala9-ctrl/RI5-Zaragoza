...
const Training = {
  ...
  mostrarResultados(d) { 
    ...
    d.zones.forEach((z, index) => { 
      ...
      const botonEditar = `<button onclick="event.stopPropagation(); Training.abrirEdicionZona(${index})" style="float:right; font-size:10px; letter-spacing:0.5px; background:transparent; border:1px solid var(--border-color-light); color:var(--text-secondary); border-radius:6px; padding:3px 8px; cursor:pointer;">EDITAR</button>`;
      if (index === 5) {
