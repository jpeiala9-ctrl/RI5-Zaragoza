...
const Wall = {
  ...
  // resultado (una publicación nueva dentro de la ventana hoy/ayer, o un
...
window.Wall = Wall;
console.log('✅ Wall v4.14 - Listener en tiempo real (onSnapshot) en vez de sondeo: solo lee cuando hay cambios de verdad');