// ==================== wall.js ====================
// Versión: 4.11 - Minimapa siempre visible si hay trackPoints, geocodificación mejorada
// ====================
  ...
  render(entries) {
    ...
    for (const entry of entries) {
      try {
        ...
        let miniMapHTML = '';
        // Mostrar minimapa si hay trackPoints y al menos 2 puntos (sin importar la distancia)
...
window.Wall = Wall;
console.log('✅ Wall v4.11 - Minimapa siempre visible si hay trackPoints');