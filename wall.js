// ==================== wall.js - Muro global con minimapa GPS claro ====================
// Versión: 4.3 - Usa distancia/tiempo real del GPS, minimapa con fondo claro
// ====================
    ...
    this.container.querySelectorAll('.gps-minimap-tap').forEach(el => {
      el.addEventListener('click', (e) => {
        ...
        if (entry && window.GPSTrackViewer) {
          ...
          console.warn('Visor no disponible o entrada sin track', entryId);
