...
// Versión: 1.2 - Fix render: try/catch por entrada + números nunca pasan por escapeHTML
// ====================
...
// FIX: cada entrada en su propio try/catch; números convertidos antes de mostrar, nunca a escapeHTML
render(entries) {
const container = document.getElementById(‘wallContainer’);
if (!container) return;
