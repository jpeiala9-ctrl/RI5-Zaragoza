// ==================== wall.js - Muro con borde según estado (verde/naranja) ====================
// Versión: 3.8 - Borde izquierdo igual que en calendario, modal con estadísticas
// ============================================================================
...
const Wall = {
  ...
  render(entries) {
          ...
          <div class="wall-item ${estadoClass}" data-entry-id="${entry.id}" data-plan-id="${entry.planId || ''}" data-sesion-index="${entry.sesionIndex || ''}">
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:12px;">
              <div style="display:flex; align-items:center; gap:12px;">
                ${avatarHTML}
                <div>
                  <div class="wall-username" style="cursor:pointer;" data-uid="${entry.userId}">${Utils.escapeHTML(usernameFormatted)}</div>
    ...
    // Evento para abrir perfil al hacer clic en el nombre de usuario
    ...
    // Mostrar mapas con marcadores minimalistas
  ...
  async _openRouteModal(entry) {
    ...
    if (mapContainer) {
      ...
      // Marcadores minimalistas también aquí
      L.circleMarker(latlngs[0], {
        radius: 3,
        color: '#aaa',
        fillColor: '#ccc',
