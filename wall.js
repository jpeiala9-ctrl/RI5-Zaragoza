// ==================== wall.js ====================
// Versión: 4.8 - Formato de kilómetros con dos decimales, zapatillas desde perfil
// ====================
...
const Wall = {
  ...
  render(entries) {
    ...
    for (const entry of entries) {
      try {
        ...
        // Formatear distancia con dos decimales
  ...
  abrirModalMapa(points, distancia, entryData = {}) {
    ...
    // Formatear ritmo medio (p.ej. "5:30 min/km")
    let ritmoFormateado = '—';
    if (entryData.ritmo && entryData.ritmo !== '—') {
...
window.Wall = Wall;
console.log('✅ Wall v4.8 - Kilómetros con dos decimales, zapatillas desde perfil');