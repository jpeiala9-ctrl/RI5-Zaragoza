...
// Versión: 4.0 - GPS track minimap + nivel y color en modal de likes
...
const Wall = {
  ...
  // ===== MINIMAP SVG desde trackPoints (CON FONDO CLARO) =====
  _renderMiniMap(trackPoints) {
    ...
    // Fallback local si GPSTracker no está cargado aún (con fondo claro)
      ...
      try {
        ...
        const gpsBadge = entry.hasGPS
          ? `<span style="
              ...
              color:#1e88e5; background:rgba(30,136,229,0.12);
