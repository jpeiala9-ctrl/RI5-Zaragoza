...
// Versión: 3.15 - CORREGIDO: Toasts amigables, envío de mensajes soporte y sincronización de contador de amigos
// ====================
...
const Storage = {
  ...
  // CORREGIDO: Sincronización correcta del contador de amigos
  async acceptFriendRequest(requestId, fromUid, toUid) { 
    ...
    try { 
      ...
      // Obtener los arrays actuales para calcular el nuevo friendsCount correctamente
      ...
      // Actualizar friendIds y friendsCount con el valor exacto (no increment)
  ...
  // CORREGIDO: Sincronización correcta del contador de amigos al eliminar
