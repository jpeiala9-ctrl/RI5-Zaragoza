...
// Versión: 3.11 - Paginación corregida en getAllUsers, mejoras de robustez
// ====================
...
const Storage = {
  ...
  // Paginación CORREGIDA: ahora almacena y usa correctamente el último documento
  async getAllUsers(limit = 20, startAfter = null) { 
    ...
    // Devolvemos también el último documento para poder continuar la paginación
