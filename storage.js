// ==================== storage.js ====================
// Versión: 3.16 - Añadidas funciones para groupSessions (getGroupSession, updateGroupSession)
// ====================
...
const Storage = {
  ...
  async updateGroupSession(groupId, data) {
    if (!groupId || !data) return false;
    try {
      await firebaseServices.db.collection('groupSessions').doc(groupId).update(data);
      return true;
    } catch (error) {
...
console.log('✅ storage.js v3.16 - Añadidas funciones para groupSessions');