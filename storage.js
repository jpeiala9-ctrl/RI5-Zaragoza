...
// Versión: 3.14 - CORREGIDO: borrarMensajeUsuario usa set en lugar de update
// ====================
...
const Storage = {
  ...
  // ✅ CORREGIDO: Usar set en lugar de update para evitar problemas de permisos
  async borrarMensajeUsuario(uid, idx) { 
    ...
    try { 
      ...
      Utils.showToast('Error al eliminar mensaje: ' + (error.message || 'desconocido'), 'error'); 
    } 
  },
