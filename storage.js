...
const Storage = {
  ...
  async getGamificationData(uid) {
    ...
    try {
      ...
      const data = doc.data();
      // Mismo guiño que en Gamification._aplicarNivelAdmin: el admin
      // siempre se ve a nivel 10, también cuando sus datos se leen por
      // esta vía directa (en vez de por Gamification.getData()).
