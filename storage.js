...
// Versión: 3.26 - Mensajes de soporte: lógica reescrita desde cero para garantizar funcionalidad
// ====================
...
const Storage = {
  ...
  // ==================== NUEVO SISTEMA DE SOPORTE (REESCRITO DESDE CERO) ====================
   ...
   * 
   * Así, el usuario siempre lee de su propia subcolección, donde tiene permisos totales.
   */
   ...
   * Esto garantiza que el usuario siempre pueda leer sus propios mensajes.
   */
