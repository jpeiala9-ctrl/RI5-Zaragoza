...
console.log('✅ gamification.js v5.17 - totalZone4/5Minutes, totalDistance, totalSessions y contadores por tipo se recalculan desde la verdad del historial al desmarcar una sesión (autocorrige desviaciones acumuladas)');