...
const Gamification = {
  ...
  //  1) Sesiones SIN GPS (o con distancia corregida a mano): la sesión
  //     cuenta como intento si su distancia total se queda dentro de un
  //     margen del 15% de la distancia estándar (ver updateAfterSession).
