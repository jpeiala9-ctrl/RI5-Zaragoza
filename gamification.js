...
// Versión: 5.2 - Colores únicos por nivel + método clearCache
// ====================
...
const Gamification = {
  ...
  // === NUEVA VERSIÓN: colores únicos por nivel ===
  getColorByLevel(level) {
    const colors = {
      1: '#6c757d', // gris oscuro
      2: '#adb5bd', // gris claro
      3: '#cd7f32', // bronce
      4: '#b87333', // cobre
      5: '#c0c0c0', // plata
      6: '#e5e4e2', // plata claro
      7: '#ffd700', // oro
      8: '#ffc107', // oro claro
      9: '#e0b0ff', // platino
    };
    if (level >= 10) return '#b9f2ff'; // diamante para nivel 10+
    return colors[level] || '#6c757d';
  },

  // === NUEVO MÉTODO PARA LIMPIAR CACHÉS LOCALES ===
