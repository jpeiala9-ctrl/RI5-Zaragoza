// ==================== gamification.js - NIVEL POR KILÓMETROS (versión definitiva) ====================
// Versión: 2.1 - El nivel se calcula según kilómetros totales. Al desmarcar se resta km y recalcula nivel.
// ====================
...
const Gamification = {
  ...
  // Tabla de niveles basada en KILÓMETROS (no XP)
  LEVELS_KM: [
    { level: 1, kmNeeded: 0 },
    { level: 2, kmNeeded: 50 },
  ...
  // Al marcar una sesión (suma km y XP)
  ...
  // Al desmarcar una sesión (resta km y XP, recalcula nivel)
  async removeSession(uid, sesion, metricas, diaIndex) {
    ...
    try {
      ...
      // Ajuste de racha: si la sesión desmarcada es la única de hoy, restamos 1 a la racha
