...
// Versión: 2.6 - Corregido cálculo de racha con fecha local (no UTC)
// ====================
...
const Gamification = {
  ...
  // ========== RECALCULAR RACHA USANDO FECHA LOCAL (CORREGIDO) ==========
    ...
    try {
      ...
      snapshot.forEach(doc => {
        ...
        if (data.timestamp) {
          ...
          // Convertir a fecha local YYYY-MM-DD (ej. "2025-05-20")
          const yyyymmdd = date.toLocaleDateString('en-CA'); // 'en-CA' da formato YYYY-MM-DD según zona local
