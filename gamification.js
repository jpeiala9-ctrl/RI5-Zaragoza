// ==================== gamification.js - NIVEL POR KILÓMETROS (con color según nivel) ====================
// Versión: 2.3 - Añadida función getColorByLevel
// ====================
...
const Gamification = {
  ...
  // Devuelve el color CSS según el nivel
  getColorByLevel(level) {
    ...
    return 'linear-gradient(135deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3)'; // Arcoíris
  },
