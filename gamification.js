// ==================== gamification.js ====================
// Versión: 5.6 - getData no crea documentos ajenos (solo propio o admin)
// ====================
...
const Gamification = {
  ...
  async getData(uid) {
    ...
    try {
      ...
      // ✅ MODIFICACIÓN: Solo creamos el documento si es el propio usuario o es administrador
      if (uid === AppState.currentUserId || AppState.isAdmin) {
        ...
        // Para usuarios ajenos sin documento, devolvemos valores por defecto en memoria
        console.warn(`⚠️ Documento gamification no encontrado para ${uid}, usando valores por defecto en memoria`);
...
console.log('✅ gamification.js con getData que no escribe documentos ajenos');