...
// Versión: 3.1 - CORREGIDA (series con repeticiones y distancia)
// 
// Todas las sesiones de series ahora incluyen los campos 'repeticiones' y 'distanciaSerie'
// y su estructura tiene el formato: "X' calentamiento + Y' series (NxZm) + Z' enfriamiento"
// ============================================================================
  ...
  runner: {
    "2k": {
      ...
      intermedio: {
        ...
        series: [
          { nombre: "Series 400m", duracion: 40, unidad: "min", desc: "6x400m con recuperación 2'.", estructura: "15' calentamiento + 10' series (6x400m) + 10' enfriamiento", sensacion: "Exigente", tipo: "series", zona: "Z4", repeticiones: 6, distanciaSerie: 400 },
          { nombre: "Series 600m", duracion: 45, unidad: "min", desc: "5x600m con recuperación 2'30.", estructura: "15' calentamiento + 12' series (5x600m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z4", repeticiones: 5, distanciaSerie: 600 },
          ...
          { nombre: "Series 800m", duracion: 50, unidad: "min", desc: "4x800m con recuperación 3'.", estructura: "15' calentamiento + 13' series (4x800m) + 10' enfriamiento", sensacion: "Muy exigente", tipo: "series", zona: "Z4", repeticiones: 4, distanciaSerie: 800 },
          { nombre: "Series 1000m", duracion: 55, unidad: "min", desc: "3x1000m con recuperación 3'.", estructura: "15' calentamiento + 12' series (3x1000m) + 10' enfriamiento", sensacion: "Fuerte", tipo: "series", zona: "Z5", repeticiones: 3, distanciaSerie: 1000 },
          ...
          { nombre: "Series 200m rápidas", duracion: 35, unidad: "min", desc: "10x200m con recuperación 1'.", estructura: "15' calentamiento + 8' series (10x200m) + 5' enfriamiento", sensacion: "Explosivas", tipo: "series", zona: "Z5", repeticiones: 10, distanciaSerie: 200 }
        ],
        tempo: [
      ...
      avanzado: {
        ...
        series: [
          { nombre: "Series 800m", duracion: 45, unidad: "min", desc: "5x800m con recuperación 3'.", estructura: "15' calentamiento + 16' series (5x800m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z5", repeticiones: 5, distanciaSerie: 800 },
          { nombre: "Series 1000m", duracion: 50, unidad: "min", desc: "4x1000m con recuperación 3'.", estructura: "15' calentamiento + 16' series (4x1000m) + 10' enfriamiento", sensacion: "Muy intenso", tipo: "series", zona: "Z5", repeticiones: 4, distanciaSerie: 1000 },
          { nombre: "Series 1200m", duracion: 55, unidad: "min", desc: "3x1200m con recuperación 3'30.", estructura: "15' calentamiento + 14' series (3x1200m) + 10' enfriamiento", sensacion: "Exigente", tipo: "series", zona: "Z5", repeticiones: 3, distanciaSerie: 1200 },
          { nombre: "Series 1600m", duracion: 60, unidad: "min", desc: "3x1600m con recuperación 4'.", estructura: "15' calentamiento + 19' series (3x1600m) + 10' enfriamiento", sensacion: "Máximo", tipo: "series", zona: "Z5", repeticiones: 3, distanciaSerie: 1600 },
          ...
          { nombre: "Series 600m", duracion: 50, unidad: "min", desc: "6x600m con recuperación 2'.", estructura: "15' calentamiento + 14' series (6x600m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z5", repeticiones: 6, distanciaSerie: 600 }
        ],
        tempo: [
          { nombre: "Tempo largo", duracion: 40, unidad: "min", desc: "25' a ritmo umbral.", estructura: "10' calentamiento + 25' Z4 + 5' enfriamiento", sensacion: "Umbral", tipo: "tempo", zona: "Z4" },
    ...
    "5k": {
      ...
      intermedio: {
        ...
        series: [
          { nombre: "Series 600m", duracion: 45, unidad: "min", desc: "6x600m con recuperación.", estructura: "15' calentamiento + 14' series (6x600m) + 10' enfriamiento", sensacion: "Intensidad", tipo: "series", zona: "Z4", repeticiones: 6, distanciaSerie: 600 },
          { nombre: "Series 800m", duracion: 50, unidad: "min", desc: "5x800m con recuperación 2'30.", estructura: "15' calentamiento + 16' series (5x800m) + 10' enfriamiento", sensacion: "Exigente", tipo: "series", zona: "Z4", repeticiones: 5, distanciaSerie: 800 },
          ...
          { nombre: "Series 1000m", duracion: 55, unidad: "min", desc: "4x1000m con recuperación 3'.", estructura: "15' calentamiento + 16' series (4x1000m) + 10' enfriamiento", sensacion: "Fuerte", tipo: "series", zona: "Z5", repeticiones: 4, distanciaSerie: 1000 },
          { nombre: "Series 400m", duracion: 45, unidad: "min", desc: "8x400m con recuperación 1'30.", estructura: "15' calentamiento + 13' series (8x400m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z4", repeticiones: 8, distanciaSerie: 400 },
          ...
          { nombre: "Series 200m rápidas", duracion: 40, unidad: "min", desc: "12x200m con recuperación 1'.", estructura: "15' calentamiento + 10' series (12x200m) + 5' enfriamiento", sensacion: "Explosivas", tipo: "series", zona: "Z5", repeticiones: 12, distanciaSerie: 200 }
        ],
        tempo: [
      ...
      avanzado: {
        ...
        series: [
          { nombre: "Series 1000m", duracion: 50, unidad: "min", desc: "5x1000m con recuperación.", estructura: "15' calentamiento + 20' series (5x1000m) + 10' enfriamiento", sensacion: "Muy intenso", tipo: "series", zona: "Z5", repeticiones: 5, distanciaSerie: 1000 },
          { nombre: "Series 1200m", duracion: 55, unidad: "min", desc: "4x1200m con recuperación 3'30.", estructura: "15' calentamiento + 19' series (4x1200m) + 10' enfriamiento", sensacion: "Exigente", tipo: "series", zona: "Z5", repeticiones: 4, distanciaSerie: 1200 },
          { nombre: "Series 1600m", duracion: 60, unidad: "min", desc: "3x1600m con recuperación 4'.", estructura: "15' calentamiento + 19' series (3x1600m) + 10' enfriamiento", sensacion: "Máximo", tipo: "series", zona: "Z5", repeticiones: 3, distanciaSerie: 1600 },
          { nombre: "Series 800m", duracion: 50, unidad: "min", desc: "6x800m con recuperación 2'.", estructura: "15' calentamiento + 19' series (6x800m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z5", repeticiones: 6, distanciaSerie: 800 },
          ...
          { nombre: "Series 600m", duracion: 55, unidad: "min", desc: "8x600m con recuperación 1'30.", estructura: "15' calentamiento + 19' series (8x600m) + 10' enfriamiento", sensacion: "Intenso", tipo: "series", zona: "Z5", repeticiones: 8, distanciaSerie: 600 }
        ],
        tempo: [
...
// ============================================
// 2. ESTRUCTURA DE MICROCICLOS PROFESIONALES
// ============================================
const PLANTILLAS_SEMANALES = {
  runner: {},
  trail: {}
};

// Función auxiliar para obtener sesiones aleatorias de la matriz
function getSesionAleatoria(tipo, modalidad, distancia, nivel) {
...
// ============================================
// 3. CONSTRUIR MICROCICLOS USANDO LA MATRIZ
// ============================================
...
PLANTILLAS_SEMANALES.runner["2k"] = {
  principiante: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        3: { tipo: 'descanso' },
        4: { tipo: 'series', variante: '200m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'base', fromMatrix: true }
      }
    ],
    cicloDescarga: {
      1: { tipo: 'descanso' },
      2: { tipo: 'rodaje', variante: 'recuperación', fromMatrix: true },
      3: { tipo: 'descanso' },
      4: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
      5: { tipo: 'descanso' },
      6: { tipo: 'descanso' },
      7: { tipo: 'largo', variante: 'suave', fromMatrix: true }
    },
  ...
  intermedio: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '400m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'corto', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'progresivo', fromMatrix: true }
      },
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'tempo', variante: 'umbral', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        4: { tipo: 'series', variante: '600m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'constante', fromMatrix: true }
      }
    ],
    cicloDescarga: {
      1: { tipo: 'descanso' },
      2: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
      3: { tipo: 'descanso' },
      4: { tipo: 'tempo', variante: 'suave', fromMatrix: true },
      5: { tipo: 'descanso' },
      6: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
      7: { tipo: 'largo', variante: 'suave', fromMatrix: true }
    },
  ...
  avanzado: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '800m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'fuerte', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'series', variante: '400m', fromMatrix: true },
        7: { tipo: 'largo', variante: 'calidad', fromMatrix: true }
      }
    ],
    cicloDescarga: {
      1: { tipo: 'descanso' },
...
PLANTILLAS_SEMANALES.runner["5k"] = {
  principiante: {
    ciclos: [
      {
        ...
        2: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        3: { tipo: 'descanso' },
        4: { tipo: 'series', variante: '300m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'base', fromMatrix: true }
      }
    ...
    cicloDescarga: {
      1: { tipo: 'descanso' },
      2: { tipo: 'rodaje', suave: true, fromMatrix: true },
      3: { tipo: 'descanso' },
      4: { tipo: 'rodaje', suave: true, fromMatrix: true },
      5: { tipo: 'descanso' },
      6: { tipo: 'descanso' },
      7: { tipo: 'largo', suave: true, fromMatrix: true }
    },
    progresionLargo: [1.0, 1.1, 1.2, 0.6],
    progresionSeries: [1.0, 1.1, 1.2, 0.5]
  },
  intermedio: {
    ciclos: [
      {
        ...
        2: { tipo: 'series', variante: '800m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'umbral', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'progresivo', fromMatrix: true }
      },
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'tempo', variante: 'largo', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        4: { tipo: 'series', variante: '1000m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'constante', fromMatrix: true }
      }
    ...
    cicloDescarga: {
      ...
      2: { tipo: 'rodaje', suave: true, fromMatrix: true },
      3: { tipo: 'descanso' },
      4: { tipo: 'tempo', suave: true, fromMatrix: true },
      5: { tipo: 'descanso' },
      6: { tipo: 'rodaje', suave: true, fromMatrix: true },
      7: { tipo: 'largo', suave: true, fromMatrix: true }
    },
    progresionLargo: [1.0, 1.15, 1.3, 0.6],
  ...
  avanzado: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '1000m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'fuerte', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'series', variante: '400m', fromMatrix: true },
...
PLANTILLAS_SEMANALES.runner["10k"] = {
    ...
    ciclos: [
      {
        ...
        2: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        3: { tipo: 'descanso' },
        4: { tipo: 'series', variante: '400m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'base', fromMatrix: true }
      }
  ...
  intermedio: {
    ciclos: [
      ...
      },
      {
        ...
        2: { tipo: 'tempo', variante: 'largo', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        4: { tipo: 'series', variante: '800m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'constante', fromMatrix: true }
      }
  ...
  avanzado: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '2000m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'fuerte', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'series', variante: '1000m', fromMatrix: true },
        7: { tipo: 'largo', variante: 'calidad', fromMatrix: true }
      }
    ],
    cicloDescarga: {
...
PLANTILLAS_SEMANALES.runner["medio"] = {
  ...
  intermedio: {
    ciclos: [
      ...
      },
      {
        ...
        2: { tipo: 'tempo', variante: 'largo', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        4: { tipo: 'series', variante: '1500m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'constante', fromMatrix: true }
      }
  ...
  avanzado: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '3000m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'fuerte', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'series', variante: '1000m', fromMatrix: true },
...
PLANTILLAS_SEMANALES.runner["maraton"] = {
    ...
    ciclos: [
      {
        ...
        2: { tipo: 'series', variante: '3000m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'maraton', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'tempo', variante: 'corto', fromMatrix: true },
        7: { tipo: 'largo', variante: 'progresivo', fromMatrix: true }
      },
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'tempo', variante: 'largo', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        4: { tipo: 'series', variante: '5000m', fromMatrix: true },
        5: { tipo: 'descanso' },
        6: { tipo: 'rodaje', variante: 'activo', fromMatrix: true },
        7: { tipo: 'largo', variante: 'constante', fromMatrix: true }
      }
  ...
  avanzado: {
    ciclos: [
      {
        1: { tipo: 'descanso' },
        2: { tipo: 'series', variante: '5000m', fromMatrix: true },
        3: { tipo: 'rodaje', variante: 'regenerativo', fromMatrix: true },
        4: { tipo: 'tempo', variante: 'maraton', fromMatrix: true },
        5: { tipo: 'rodaje', variante: 'suave', fromMatrix: true },
        6: { tipo: 'series', variante: '2000m', fromMatrix: true },
        7: { tipo: 'largo', variante: 'calidad', fromMatrix: true }
      }
    ],
    cicloDescarga: {
...
// ============================================
// 4. TRAIL (Estructura similar, usando matriz de trail)
// ============================================
...
distanciasTrail.forEach(dist => {
  ...
  niveles.forEach(nivel => {
    // Clonar estructura de runner y adaptar para trail
    ...
    if (base.ciclos) {
      base.ciclos = base.ciclos.map(ciclo => {
        ...
        Object.keys(ciclo).forEach(dia => {
          ...
          // Para trail, cambiar el tipo de sesión cuando corresponda
          if (nuevoCiclo[dia].tipo === 'series') {
            nuevoCiclo[dia].variante = 'cuestas';
          }
          if (nuevoCiclo[dia].tipo === 'rodaje') {
            nuevoCiclo[dia].variante = 'sendero';
          }
          if (nuevoCiclo[dia].tipo === 'largo') {
            nuevoCiclo[dia].variante = 'trail';
          }
          if (nuevoCiclo[dia].tipo === 'tempo') {
            nuevoCiclo[dia].variante = 'desnivel';
          }
        });
        return nuevoCiclo;
      });
    ...
    if (base.cicloDescarga) {
      ...
      Object.keys(base.cicloDescarga).forEach(dia => {
        if (base.cicloDescarga[dia].tipo === 'rodaje') {
          base.cicloDescarga[dia].variante = 'sendero';
        }
      });
    }
...
// Función de utilidad para obtener una sesión específica de la matriz
window.getSesionFromMatrix = function(tipo, modalidad, distancia, nivel, variante) {
  const db = ENTRENAMIENTOS_DB[modalidad]?.[distancia]?.[nivel]?.[tipo];
  if (!db) return null;
  
  // Si hay variante, buscar por nombre
  if (variante) {
    const encontrada = db.find(s => 
      s.nombre.toLowerCase().includes(variante.toLowerCase()) ||
      (s.tipo === tipo && s.nombre.includes(variante))
    );
    if (encontrada) return encontrada;
  }
  
  // Si no, devolver una aleatoria del tipo correcto
  return db[Math.floor(Math.random() * db.length)];
};

console.log('✅ Biblioteca de microciclos profesionales con matriz de 1.344 entrenamientos');
console.log('📊 Total microciclos:', 
  Object.keys(PLANTILLAS_SEMANALES.runner).length * 3 + 
  Object.keys(PLANTILLAS_SEMANALES.trail).length * 3, 'perfiles');