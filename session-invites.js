...
// VERSIÓN MODIFICADA: soporte para plan personalizado y orden de pasos
// ====================
...
const SessionInvites = {
  ...
  _anadirPaso() {
    ...
    for (let i = 0; i < pasos.length; i++) {
      ...
      // Para sesiones de carrera usamos "ENFRIAMIENTO"; para fuerza podría ser "ESTIRAMIENTOS"
    ...
    // Crear el nuevo paso con valores por defecto
    const nuevoPaso = { icono: '📌', titulo: '', accion: '', porque: '' };
    
    // Insertar antes del enfriamiento si existe, si no, al final
  ...
  // ========== ACEPTAR SESIÓN (MODIFICADO PARA PLAN PERSONALIZADO) ==========
...
console.log('✅ SessionInvites con soporte para plan personalizado y orden de pasos corregido');