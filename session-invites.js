...
const SessionInvites = {
  ...
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: '#6A8CA5', bg: 'rgba(106,140,165,0.18)' },  // Azul suave ajustado
      tempo:    { accent: '#C4907A', bg: 'rgba(196,144,122,0.20)' },   // Terracota suave ajustado
      series:   { accent: '#7FA57F', bg: 'rgba(127,165,127,0.18)' },   // Verde suave ajustado
      largo:    { accent: '#C47A8E', bg: 'rgba(196,122,142,0.20)' },   // Rosa suave ajustado
      strength: { accent: '#A07AB0', bg: 'rgba(160,122,176,0.18)' },   // Lila suave ajustado
      descanso: { accent: '#D0D0D0', bg: 'rgba(208,208,208,0.12)' }    // Blanco grisáceo suave
    };
...
console.log('✅ SessionInvites v12.6 - Colores ajustados para modo oscuro');