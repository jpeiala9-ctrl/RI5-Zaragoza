...
const SessionInvites = {
  ...
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: '#8AA0B0', bg: 'rgba(138,160,176,0.12)' },
      series:   { accent: '#9BB5A0', bg: 'rgba(155,181,160,0.12)' },
      tempo:    { accent: '#C9A78B', bg: 'rgba(201,167,139,0.12)' },
      largo:    { accent: '#C99BA5', bg: 'rgba(201,155,165,0.12)' },
      strength: { accent: '#8A8A8A', bg: 'rgba(138,138,138,0.10)' },
      descanso: { accent: 'var(--border-color-light)', bg: 'transparent' }
    };
...
console.log('✅ SessionInvites v12.7 - Colores oficiales del calendario en tono tenue + carga animada del historial');