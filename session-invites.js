...
//
// v12: colores suaves por tipo de sesión en el historial de sesiones
// creadas (tanto en la lista como en el modal de detalle). Cada tarjeta
// usa el color asociado al tipo: rodaje (Z1), tempo (Z3), series (Z2),
// largo (Z4), fuerza (Z6) y descanso (neutro). Esto hace que el historial
// sea más legible y coherente con el resto de la interfaz.
// ====================
...
const SessionInvites = {
  ...
  // ===== AUXILIAR DE COLORES POR TIPO =====
  // Devuelve el acento y el fondo suave asociado a cada tipo de sesión.
  // Reutiliza las variables CSS de zona (--zone-1 a --zone-6) para que
  // se adapten al tema claro/oscuro automáticamente.
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: 'var(--zone-1)', bg: 'rgba(138,160,176,0.12)' },
      tempo:    { accent: 'var(--zone-3)', bg: 'rgba(201,167,139,0.12)' },
      series:   { accent: 'var(--zone-2)', bg: 'rgba(155,181,160,0.12)' },
      largo:    { accent: 'var(--zone-4)', bg: 'rgba(201,155,165,0.14)' },
      strength: { accent: 'var(--zone-6)', bg: 'rgba(138,138,138,0.10)' },
      descanso: { accent: '#666666', bg: 'rgba(102,102,102,0.08)' }
    };
    return mapa[tipo] || { accent: 'var(--border-color)', bg: 'transparent' };
  },
  ...
  // ============================================================
  // HISTORIAL CON COLORES POR TIPO
  // ============================================================
  ...
  async mostrarHistorial() {
    ...
    // 🔥 v12: aplicar colores suaves por tipo
  ...
  // ============================================================
  // DETALLE DEL HISTORIAL CON COLOR POR TIPO
  // ============================================================
...
console.log('✅ SessionInvites v12 - Colores suaves por tipo de sesión en el historial');