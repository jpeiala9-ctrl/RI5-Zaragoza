...
//
// v12.4: Paleta de colores optimizada para modo oscuro, con luminosidad
//        reducida para evitar efecto neón, manteniendo diferenciación.
// ====================
...
const SessionInvites = {
  ...
  // ===== AUXILIAR DE COLORES POR TIPO (VERSIÓN OPTIMIZADA PARA MODO OSCURO) =====
  // Colores con luminosidad reducida y saturación moderada para que en modo
  // oscuro no resulten neón, manteniendo buena diferenciación entre tipos.
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: '#4A6A80', bg: 'rgba(74,106,128,0.15)' },  // Azul grisáceo oscuro
      tempo:    { accent: '#A87A60', bg: 'rgba(168,122,96,0.18)' },   // Terracota apagado
      series:   { accent: '#5A8A5A', bg: 'rgba(90,138,90,0.15)' },    // Verde apagado
      largo:    { accent: '#A86A78', bg: 'rgba(168,106,120,0.18)' },  // Rosa grisáceo
      strength: { accent: '#8A6A9A', bg: 'rgba(138,106,154,0.16)' },  // Lila apagado
      descanso: { accent: '#808080', bg: 'rgba(128,128,128,0.12)' }   // Gris medio
    };
  ...
  // ============================================================
  // HISTORIAL CON COLORES OPTIMIZADOS PARA MODO OSCURO
  // ============================================================
...
console.log('✅ SessionInvites v12.4 - Paleta optimizada para modo oscuro');