...
// VERSIÓN MODIFICADA: soporte para plan personalizado
// ====================
...
const SessionInvites = {
  ...
  // Busca un plan personalizado existente (por el campo tipo)
  ...
  // Crea un plan personalizado para el usuario, desde fechaInicio hasta 31/12 de ese año
  ...
  // Construye el objeto detalle de la sesión
  ...
  // ========== MOSTRAR MODAL DE INVITACIÓN (con soporte para plan personalizado) ==========
  ...
  // ========== FUNCIÓN AUXILIAR PARA RELLENAR VALORES POR DEFECTO (ya existente) ==========
...
console.log('✅ SessionInvites con soporte para plan personalizado');