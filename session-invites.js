...
//
// v12.3: colores más suaves y menos saturados para el historial de
// sesiones, con mejor visibilidad en modo oscuro sin parecer neón.
// Descanso ahora es blanco grisáceo para distinguirlo claramente.
// Opacidades de fondo reducidas para un aspecto más limpio.
// ====================
...
const SessionInvites = {
  ...
  // ===== AUXILIAR DE COLORES POR TIPO (VERSIÓN SUAVE) =====
  // Colores pastel con saturación reducida para no saturar en modo oscuro.
  // Descanso en blanco grisáceo para diferenciarlo bien del resto.
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: '#7A9BB5', bg: 'rgba(122,155,181,0.18)' },  // Azul suave
      tempo:    { accent: '#D4A08A', bg: 'rgba(212,160,138,0.20)' },  // Terracota suave
      series:   { accent: '#8FB58F', bg: 'rgba(143,181,143,0.18)' },  // Verde suave
      largo:    { accent: '#D48A9E', bg: 'rgba(212,138,158,0.20)' },  // Rosa suave
      strength: { accent: '#B08ABF', bg: 'rgba(176,138,191,0.18)' },  // Lila suave
      descanso: { accent: '#E0E0E0', bg: 'rgba(224,224,224,0.12)' }   // Blanco grisáceo
    };
  ...
  // ============================================================
  // DETALLE DEL HISTORIAL CON COLORES SUAVES
  // ============================================================
...
console.log('✅ SessionInvites v12.3 - Colores suaves y menos saturados');