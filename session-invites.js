...
// VERSIÓN COMPLETA: soporte para plan personalizado, orden de pasos,
// orden cronológico de invitaciones, ajuste de fecha de inicio,
// auto-envío del administrador, y flujo encadenado sin saltos visuales.
// ====================
...
const SessionInvites = {
  ...
  async _mostrarModalInvite(id, data) {
    ...
    if (sesion.tipo === 'descanso') {
      ...
      requestAnimationFrame(() => {
        setTimeout(() => { Utils.hideLoading(); }, 50);
      });
      return;
    }
...
console.log('✅ SessionInvites v7 - flujo encadenado sin saltos visuales entre invitaciones');