...
//
// v12.2: colores más contrastados y diferenciados en el historial de
// sesiones: rodaje (azul medio), tempo (naranja terracota), series (verde
// medio), largo (rosa fuerte), fuerza (púrpura grisáceo), descanso (gris
// azulado claro). Opacidad de fondo aumentada para mejor visibilidad.
// ====================
...
const SessionInvites = {
  ...
  // ===== AUXILIAR DE COLORES POR TIPO (VERSIÓN MEJORADA) =====
  // Colores más contrastados y fácilmente diferenciables entre sí.
  // Opacidad aumentada para mejor visibilidad en tema oscuro.
  _colorTipo(tipo) {
    const mapa = {
      rodaje:   { accent: '#6A8EB0', bg: 'rgba(106,142,176,0.25)' },  // Azul medio
      tempo:    { accent: '#D4896B', bg: 'rgba(212,137,107,0.26)' },  // Naranja terracota
      series:   { accent: '#7CA87C', bg: 'rgba(124,168,124,0.24)' },  // Verde medio
      largo:    { accent: '#C96A8E', bg: 'rgba(201,106,142,0.25)' },  // Rosa fuerte
      strength: { accent: '#9B6DA8', bg: 'rgba(155,109,168,0.24)' },  // Púrpura grisáceo
      descanso: { accent: '#8899AA', bg: 'rgba(136,153,170,0.22)' }   // Gris azulado claro
    };
  ...
  // ============================================================
  // HISTORIAL CON COLORES MEJORADOS Y CONTRASTADOS
  // ============================================================
  ...
  // ============================================================
  // DETALLE DEL HISTORIAL CON COLORES MEJORADOS
  // ============================================================
...
console.log('✅ SessionInvites v12.2 - Colores mejorados y contrastados');