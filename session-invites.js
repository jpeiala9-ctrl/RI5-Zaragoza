...
// orden cronológico de invitaciones, ajuste de fecha de inicio del plan,
// y ahora permite al administrador enviarse sesiones a sí mismo.
// ====================
...
const SessionInvites = {
  ...
  // ========== FUNCIÓN MODIFICADA: permite al admin enviarse a sí mismo ==========
  _precargarUsuarios() {
    ...
    this._precargaUsuariosPromise = firebaseServices.db.collection('users').orderBy('username_lowercase').get()
      .then(snapshot => {
        // Ya no filtramos al usuario actual, así el admin puede seleccionarse a sí mismo
...
console.log('✅ SessionInvites v6 - permite auto-envío del admin a sí mismo');