    ...
    modal.innerHTML = `
      ...
      <div style="padding:16px 20px; overflow-y:auto; flex:1; background:${color.bg};">
        ...
        <div style="text-align:center; margin-top:14px;">
          <button onclick="SessionInvites._eliminarHistorial(${idx}); SessionInvites._cerrarModal('sessHist');" class="action-button" style="width:auto; padding:0 24px; margin:0; background:transparent; border:1px solid var(--zone-5); color:var(--zone-5);">🗑️ ELIMINAR SESIÓN</button>
        </div>
      </div>
      <div style="padding:16px 20px; background:var(--bg-primary); border-top:1px solid var(--border-color); display:flex; justify-content:space-between; gap:12px;">
