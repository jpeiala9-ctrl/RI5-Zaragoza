...
// VERSIÓN: 4.24 - Añadido soporte para tab "GRUPO" en amigos
// ====================
      ...
      if(tab === 'amigos') {
        if (window.Friends) {
          ...
          if (activeAmigosTab) {
            ...
            } else if (tabText.includes('grupo')) {
              // NUEVO: cargar sesiones grupales
              if (typeof Friends.cargarSesionesGrupo === 'function') {
                await Friends.cargarSesionesGrupo();
              }
            }
          } else {
            await Friends.cargarTodosUsuarios(true);
...
window.cambiarAmigosTab = function(tab) {
  ...
  const tabMap = { 'buscar': 0, 'solicitudes': 1, 'lista': 2, 'grupo': 3 };
  ...
  if (tab === 'grupo' && window.Friends && typeof Friends.cargarSesionesGrupo === 'function') {
    Friends.cargarSesionesGrupo();
  }
};
...
console.log('✅ app.js v4.24 - Soporte para tab "GRUPO" en amigos');