...
// VERSIÓN: 4.22 - Admin: perfil se abre sobre listado sin ocultarlo
// ====================
...
const Admin = {
  ...
  // --- Modal de detalle de usuario (CORREGIDO: no oculta listado) ---
  async verPerfil(uid) {
    ...
    try {
      ...
      modal.classList.add('active');
      modal.style.zIndex = '100002'; // Por encima del listado
