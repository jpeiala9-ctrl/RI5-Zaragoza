...
// VERSIÓN: 4.24 - Añadido soporte para compartir sesiones
// ====================
      ...
      if(tab === 'amigos') {
        if (window.Friends) {
          ...
          if (activeAmigosTab) {
            ...
            } else if (tabText.includes('compartidos')) {
              await Friends.cargarCompartidos();
              await Friends.actualizarBadgeCompartidos();
            }
          } else {
            await Friends.cargarTodosUsuarios(true);
          }
...
// ==================== CAMBIAR AMIGOS TAB (CON COMPARTIDOS) ====================
window.cambiarAmigosTab = function(tab) {
  ...
  const tabMap = { 'buscar': 0, 'solicitudes': 1, 'lista': 2, 'compartidos': 3 };
  ...
  if (tab === 'compartidos' && window.Friends) {
    Friends.cargarCompartidos();
    Friends.actualizarBadgeCompartidos();
  }
};
