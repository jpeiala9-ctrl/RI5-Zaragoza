...
// VERSIÓN: 4.19 - Dashboard integrado y datos reales
// ====================
...
const AppState = {
  ...
  async setCurrentUser(uid, email, userData = null) {
    ...
    if (document.getElementById('tab-inicio') && document.getElementById('tab-inicio').classList.contains('active') && window.Dashboard) {
      setTimeout(() => Dashboard.render(), 500);
    }
  },
