    ...
    try {
      ...
      if (usuarios.length === 0) {
        ...
        for (const user of usuarios) {
          ...
          // 🔥 CORREGIDO: se cierra la lista antes de abrir el perfil, y se elimina el emoticono del ojo
          html += `
            <div style="display:flex; align-items:center; justify-content:space-between; padding:10px 12px; background:var(--bg-secondary); border-radius:10px; cursor:pointer; border:1px solid var(--border-color);" onclick="Admin.cerrarListModal(); Admin.verPerfil('${user.uid}')">
              <div>
