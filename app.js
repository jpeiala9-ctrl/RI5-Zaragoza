...
// Versión: 2.1 - CORREGIDA (restauración de últimas zonas)
//
// Cambio principal:
// - En la restauración de sesión, se llama a Training.mostrarResultadosGuardados(calc) en lugar de UI.mostrarResultadosGuardados(calc)
    ...
    try {
      ...
      if (currentUser && currentUser.uid === savedUid) {
        ...
        if (userDoc.exists) {
          ...
          // === CORRECCIÓN AQUÍ: usar Training.mostrarResultadosGuardados ===
