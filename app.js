...
// VERSIÓN: 4.8 - Fix: escapeHTML acepta cualquier tipo primitivo; listener muro corregido
// ====================
...
// ==================== UTILS ====================
const Utils = {
// FIX: convierte cualquier tipo a String antes de escapar.
// Evita TypeError: str.replace is not a function cuando llega un número (entry.duration, entry.tss, etc.)
escapeHTML(str) {
...
```
// FIX: detener listener del muro cuando se cambia de pestaña
