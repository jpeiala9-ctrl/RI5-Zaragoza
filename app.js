...
// VERSIÓN: 4.51 - Tarjeta de conversación de soporte (admin), 2ª pasada:
//                 foto+nombre ahora centrados verticalmente en TODA la
//                 altura de la tarjeta (antes solo en la mitad superior).
//                 La tarjeta se divide en 3 bloques iguales: izquierda
//                 (foto+nombre), centro (preview del último mensaje,
//                 solo en la parte baja de ese bloque), derecha (fecha/
//                 aviso/papelera, sin cambios de posición). Si hay
//                 mensajes no leídos, la tarjeta entera se pinta del
//                 color de notificación (--notification-color) y los
//                 textos pasan a tono oscuro para seguir leyéndose.
// ====================
