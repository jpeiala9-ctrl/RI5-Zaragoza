// ==================== app.js - VERSIÓN COMPLETA (TIEMPO REAL TOTAL) CON PRECARGA DE AMIGOS, MURO Y MENSAJES ====================
// VERSIÓN: 4.17 - Añadida precarga de amigos, muro y mensajes al login/restauración (sin precargar perfil)
// ====================
...
const AppState = {
  ...
  actualizarBadgeChat() {
    ...
    if (listaTab) {
      if (this.mensajesAmigosNoLeidos > 0) {
        listaTab.style.color = '#E67E22';  // NARANJA
