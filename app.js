// ==================== app.js - VERSIÓN COMPLETA CORREGIDA (CON ADMIN Y ELIMINAR USUARIO) ====================
...
// ==================== MÓDULO ADMIN (CON FUNCIÓN ELIMINAR USUARIO) ====================
const Admin = {
  usersPagination: {
    lastDoc: null,
    hasMore: true,
  ...
  async eliminarUsuario(uid, username) {
    ...
    try {
      ...
      // Eliminar subcolección historial
      ...
      // Eliminar planes y sus sesiones
      ...
      // Eliminar subcolección calculos
      ...
      // Eliminar mensajes (entrada y salida)
      ...
      this.cargarUsuarios(true); // Recargar lista
    } catch (error) {
