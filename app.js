...
// VERSIÓN: 4.23 - Admin: perfil optimizado (consultas en paralelo y caché)
// ====================
...
const Admin = {
  ...
  // --- Modal de detalle de usuario (OPTIMIZADO: consultas en paralelo y caché) ---
  async verPerfil(uid) {
    ...
    try {
      ...
      if (content) content.innerHTML = '<div style="text-align:center; padding:40px;">⏳ Cargando perfil...</div>';
