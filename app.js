...
// VERSIÓN: 4.8 - Corregido error de PlanGenerator no definido que rompía el login
// ====================
...
if (uid) {
  ...
  localStorage.removeItem('ri5_is_admin');
  // Detener listeners del muro si se cierra sesión
  if (window.Wall) {
...
try {
  ...
  // FIX: En Firestore, el orderBy debe ser sobre el mismo campo que el filtro de rango (>=, <=)
...
```
// FIX: detener listener del muro al salir de esa pestaña
