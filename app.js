...
const Utils = {
  ...
  // colorFinal (opcional): color al que viran las letras al terminar la
  // entrada. Las letras SIEMPRE entran con los colores de nivel de la app
  // (LEVEL_COLORS) -- eso no cambia. Por defecto, tras la entrada todas
  // viran a dorado (efecto original del splash). Pero en botones con
  // fondo YA dorado (p.ej. "Acceder"/"Registrarse", que usan var(--gold)
  // como fondo) ese dorado final se diluye contra su propio fondo, en los
  // dos temas -- ahí se pasa un colorFinal distinto (de contraste) para
  // que el texto siga siendo legible una vez asentado, sin perder el
  // efecto de colores de nivel durante la entrada.
