...
// Versión: 2.3 - CORREGIDA (restauración de últimas zonas con timeout y activación de pestaña)
//
// Cambios respecto a la versión 2.2:
// - Se añade un setTimeout al mostrar los resultados después de restaurar la sesión,
//   para garantizar que el DOM esté listo y la pestaña 'entreno' activa.
// - Se mantiene la llamada original y se duplica con retraso para mayor robustez.
      ...
      if (currentUser && currentUser.uid === savedUid) {
        ...
        if (userDoc.exists) {
          ...
          if(calc) { 
            ...
            // Esperar a que el DOM se actualice y luego mostrar resultados
            setTimeout(() => {
              if (window.Training) {
