...
// VERSIÓN: 4.9 - Panel admin optimizado: caché, paginación mensajes, debounce, índices corregidos
// ====================
...
const Admin = {
  ...
  async cargarUsuarios(reset = false) {
    ...
    try {
      ...
      query = query.select('username', 'email', 'premium', 'expires', 'calculosMes', 'created', 'username_lowercase');
