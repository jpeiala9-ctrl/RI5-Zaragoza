...
// VERSIÓN: 4.2 - Límite de cálculos gratis (10/mes) + mejoras de robustez
// ====================
...
const AppState = {
  ...
  async incrementarCalculo() {
    ...
    const limite = this.isPremium ? Infinity : 10; // 10 cálculos gratis al mes
...
const UI = {
  ...
  // UNIFICACIÓN: función genérica para actualizar cualquier consejo
  updateTip(elementId) {
...
// Funciones para cambiar pestañas de amigos (incluye chat)
