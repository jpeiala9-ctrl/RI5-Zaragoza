...
// VERSIÓN: 4.13 - CORREGIDO: chat con notificaciones en tiempo real, mensajes leídos, admin puede eliminar mensajes, contador de amigos sincronizado
// ====================
...
const AppState = {
  ...
  iniciarListeners() {
    ...
    // ✅ NUEVO: Escuchar mensajes nuevos en conversaciones para notificaciones en tiempo real
    this.unsubscribeNewMessages = firebaseServices.db
      ...
      .onSnapshot((snapshot) => {
        ...
        console.error('Error en listener de mensajes nuevos:', error);
      });
  },
