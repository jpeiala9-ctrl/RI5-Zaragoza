...
// Versión: 2.8 - Corregido: initDiasCheckboxes con 5 días por defecto
...
const UI = {
  ...
  initDiasCheckboxes() { 
    ...
    for(let i = 0; i < 7; i++) { 
      const n = i + 1; 
      // Por defecto: marcar L, M, X, J, V (5 días)
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  UI.validarTodo();
  UI.initDiasCheckboxes(); // ← AHORA MARCA 5 DÍAS POR DEFECTO
  UI.setFechaActual();
