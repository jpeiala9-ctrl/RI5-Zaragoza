...
// VERSIÓN: 4.19 - Corrección de persistencia de sesiones forzadas (naranja)
// ====================
...
const AppState = {
  ...
  planActualId: null,
  sesionesRealizadas: {},
  sesionesForzadas: {},      // AÑADIDO para mantener color naranja
  feedbackSesiones: {},
  ...
  async cargarPlanDesdeHistorial(planId) {
    ...
    try {
      ...
      if (AppState) {
        ...
        // === CORRECCIÓN: restaurar también las sesiones forzadas ===
