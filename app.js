...
// VERSIÓN: 4.21 - Admin: corrección definitiva de modales (lista y perfil) con restauración exacta
// ====================
...
const Admin = {
  ...
  cerrarModalUsuario() {
    ...
    if (this._listModalOpen) {
      ...
      if (listModal) {
        ...
        // Asegurar que el contenido se mantenga
        this._listModalOpen = false;
      }
    }
  },
  ...
  async mostrarUsuariosPorFiltro(tipo) {
    ...
    try {
      ...
      // Renderizar lista con stopPropagation para evitar cierre accidental
