...
// Versión: 2.0 - Adaptada al nuevo sistema de microciclos
...
window.addEventListener('load', async function() {
  ...
  try {
    ...
    if (!currentUser || currentUser.uid !== savedUid) {
      // Usuario no coincide, limpiar localStorage
      localStorage.removeItem('ri5_current_user');
      localStorage.removeItem('ri5_user_email');
      localStorage.removeItem('ri5_is_admin');
      return;
    ...
    // Restaurar último cálculo (AHORA Training YA ESTÁ DISPONIBLE)
