...
// VERSIÓN: 4.31 - Sistema de mensajes de soporte unificado + botones más pequeños
// ====================
...
const AppState = {
  ...
  iniciarListeners() {
    ...
    // ===== NUEVO LISTENER PARA MENSAJES DE SOPORTE (TIEMPO REAL) =====
    this.unsubscribeMensajesSoporte = firebaseServices.db
      ...
      .onSnapshot(async (snapshot) => {
        ...
        if (this.mensajesNoLeidos !== noLeidos) {
          ...
          // Si el usuario está en la pestaña de soporte, recargar mensajes
...
const Admin = {
  ...
  abrirMensajeUsuario(uid, username) {
    ...
    if (texto && texto.trim()) {
      // Usamos el sistema unificado de soporte
  ...
  async enviarMensajeUsuario(uid, texto) {
    ...
    try {
      ...
      // Recargar mensajes del admin para actualizar la lista
...
const UI = {
  ...
  actualizarBadgeMensajes() {
    ...
    // También actualizar el contador en la pestaña de soporte
