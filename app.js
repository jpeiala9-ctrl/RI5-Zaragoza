// ==================== app.js - VERSIÓN COMPLETA (SESIÓN PERSISTENTE GARANTIZADA) ====================
// VERSIÓN: 4.14 - Restauración de sesión delegada a onAuthStateChanged
// ====================
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Ya no llamamos a checkSavedSession manualmente. Dejamos que el listener de Auth decida.
  // Simplemente mostramos el login mientras se resuelve el estado de autenticación.
  ...
  if (!savedUid) {
    ...
    // Mientras tanto, mostramos el loading para evitar parpadeos.
    Utils.showLoading();
    // El listener onAuthStateChanged en auth.js se encargará de llamar a setCurrentUser
    // y mostrar mainContent o redirigir a login/verificación.
    // Ocultaremos el loading cuando la promesa de verificación se resuelva (dentro de auth.js)
  }
