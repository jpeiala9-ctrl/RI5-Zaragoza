// ==================== app.js - VERSIÓN COMPLETA CON BARRA INFERIOR ====================
// VERSIÓN: 5.0 - Compatible con nuevo diseño (COROS) y paginación mejorada
// ====================
...
const Admin = {
  ...
  cargarMasUsuarios() {
    if (this.usersPagination.loading) {
      Utils.showToast('Cargando usuarios...', 'info');
      return;
    }
    if (this.usersPagination.hasMore) {
...
window.switchToTab = function(tabId) {
  ...
  if (tabId === 'entreno') {
    ...
    if (savedCalc && window.Training) {
      try { window.Training.mostrarResultadosGuardados(JSON.parse(savedCalc)); } catch(e) {}
    }
  }
...
window.actualizarDashboard = async function() {
  ...
  let weeklyKm = 0, weeklySessions = 0, adherence = 0;
  try {
  ...
  } catch(e) { console.warn('Error obteniendo stats del plan:', e); }
...
function initBottomNav() {
  ...
  // Mostrar botón de admin en el menú si corresponde (ya existe en el HTML, no es necesario añadirlo aquí)
