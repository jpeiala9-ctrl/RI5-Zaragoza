...
// Versión: 4.24 - Bump de caché (v418 -> v419): session-invites.js -- FIX
//                del generador de sesión (session-invites.js v14.4): al
//                cambiar el tipo de sesión (ej. series -> rodaje), el
//                paso "🏃 + CARRERA EXTRA" que se hubiera añadido antes
//                se quedaba colgado en la lista en vez de quitarse solo.
// Versión: 4.23 - Bump de caché (v417 -> v418): calendar.js -- FIX del
//                desglose de sesión (calendar.js v2.75): al marcar una
//                sesión como realizada sin GPS, calentamiento y
//                enfriamiento se quedaban siempre en 0.00 km en el
//                Dashboard/Muro. Sin este bump, los móviles con la app ya
//                instalada seguirían sirviendo el calendar.js viejo desde
//                caché.
...
console.log('[SW] sw.js cargado correctamente (v419)');