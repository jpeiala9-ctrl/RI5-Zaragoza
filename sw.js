...
const CACHE_NAME = 'ri5-v432'; // 🔥 FIX: confianza de la rampa ahora mira la última tirada larga real, no solo el TSS general (calendar.js)
...
console.log('[SW] sw.js cargado correctamente (v432)');