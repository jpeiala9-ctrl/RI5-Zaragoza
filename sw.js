...
// Versión: 3.88 - Bump de caché (v371 -> v372): wall.js y profile.js -- FIX
//                mini-mapa del track GPS desaparecido. Causa: al terminar
//                una sesión con GPS, calendar.js hace primero un add() del
//                entry con hasGPS:true pero SIN trackPoints (los puntos GPS
//                se añaden con un update() posterior, hecho desde
//                gps-tracker.js después de calcular los récords por
//                tramo). Desde las optimizaciones de lecturas de v4.16
//                (wall.js) y v10.13 (profile.js), el muro decide no
//                repintar si "no ha cambiado nada" comparando solo id/
//                likeCount/likes.length, y el perfil solo refrescaba la
//                miniatura si ya existía el contenedor del mini-mapa --
//                así que ninguno de los dos se enteraba de que el
//                update() posterior con los trackPoints ya había llegado,
//                y la tarjeta se quedaba sin mini-mapa, sin capa de tap,
//                y sin poder abrir el modal del visor GPS al pulsarla.
//                Fix: wall.js ahora compara también hasGPS/trackPoints.length/
//                mapSnapshot en _sonIgualesEntradas; profile.js añade esos
//                mismos tres datos como atributos data-* a cada tarjeta y
//                los compara en _reconciliarMisEntrenamientos, recreando
//                la tarjeta si cambió la estructura del mini-mapa (y solo
//                sustituyendo la imagen si únicamente llegó un mapSnapshot
//                nuevo). Sin este bump de caché, quien ya tuviera la app
//                instalada seguiría viendo sw.js viejo sirviendo
//                wall.js/profile.js viejos y el fallo parecería no
//                arreglado.
...
console.log('[SW] sw.js cargado correctamente (v372)');