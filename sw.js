...
// Versión: 3.00 - Bump de caché (v240 -> v241): session-invites.js v11,
//                rediseño puramente visual del generador de sesiones (sin
//                cambios de cálculo ni lógica): cada paso (calentamiento/
//                parte principal/enfriamiento/extras) pasa a ser una
//                tarjeta con acento de color propio, y los botones
//                "+ CARRERA"/"+ FUERZA" quedan visualmente equilibrados.
// =====================================================================

const CACHE_NAME = 'ri5-v241';
