...
// Versión: 3.20 - Bump de caché (v260 -> v261): session-invites.js -- el
//                Paso 3 del generador de sesiones ("elige usuarios") ahora
//                tiene grupos de destinatarios: chips para marcar de golpe
//                a todos los miembros de un grupo, y un modal aparte para
//                crear/editar/eliminar grupos (colección Firestore nueva
//                'sessionGroups').
// =====================================================================

const CACHE_NAME = 'ri5-v261';
...
console.log('[SW] sw.js cargado correctamente (v261)');
