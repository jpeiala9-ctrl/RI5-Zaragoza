...
const CACHE_NAME = 'ri5-v434'; // 🔥 FIX: botón de premium ya no aparece en la pantalla "sin entrenador" del calendario (calendar.js)
...
console.log('[SW] sw.js cargado correctamente (v434)');