...
const CACHE_NAME = 'ri5-v423'; // 🔥 FIX: entriesConLikesNuevos con {id,ts} (app.js) para que irANotificacionDeLike() navegue + puntito de like sin leer en Perfil (profile.js, wall.js)
