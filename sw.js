...
// Versión: 4.23 - Bump de caché (v422 -> v423): app.js, index.html --
//                FIX del bug reportado: al tocar la notificación de "me
//                gusta" (icono "Comunidad" de abajo O subpestaña "📢
//                Muro", que también tiene su propia bolita) se pedía
//                priorizar ir al Muro y centrar ahí la tarjeta si sigue
//                dentro de sus 24h, y solo caer a Perfil ("mis últimos
//                entrenamientos") si ya se salió de esa ventana -- antes
//                los dos puntos de entrada redirigían siempre a Perfil
//                sin comprobar el Muro primero. Se unifica en una sola
//                función (window.irANotificacionDeLike, index.html) que
//                usan ambos sitios, para que no puedan volver a
//                desincronizarse como pasó la vez anterior. Para poder
//                decidir la vigencia de las 24h en el momento exacto del
//                toque (no cuando llegó el aviso), AppState.
//                entriesConLikesNuevos pasa de guardar solo el id de
//                cada sesión a guardar {id, ts} (app.js). El caso de que
//                la tarjeta ya no sea alcanzable en ningún sitio (bolita
//                que se apaga sola) no ha cambiado -- ya se resolvía
//                bien desde antes en AppState.iniciarListeners().
//                También se corrige el aviso de consola de más abajo,
//                que llevaba varias versiones desincronizado del número
//                de caché real (decía "v417" cuando ya iba por v422).
...
const CACHE_NAME = 'ri5-v423'; // 🔥 fix notificación de "me gusta": prioriza Muro (24h) sobre Perfil, unificado en una sola función
...
console.log('[SW] sw.js cargado correctamente (v423)');