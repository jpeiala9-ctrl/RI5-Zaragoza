...
// Versión: 2.88 - Bump de caché (v228 -> v229): session-invites.js corrige
//                que las sesiones de SERIES enviadas por el admin perdían el
//                campo segundosEsfuerzo al guardarse -- calendar.js no podía
//                entonces separar esfuerzo de descanso al marcar la sesión
//                como hecha, y la zona salía calculada con el ritmo medio
//                diluido por los descansos (ej. Z1 en vez de Z4/Z5).
// =====================================================================
//
// Estrategia:
