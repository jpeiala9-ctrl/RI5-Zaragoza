...
// Versión: 2.89 - Bump de caché (v229 -> v230): session-invites.js corrige
//                que, al aceptar/rechazar una sesión enviada por el admin,
//                la animación "EN PROCESO" quedaba tapada por el propio
//                modal de la invitación (su overlay tenía más z-index que
//                #loadingOverlay) y solo se veía un instante justo al
//                cerrarse el modal -- dando la sensación de que la
//                animación se cortaba, sobre todo con varias sesiones
//                seguidas en la cola.
// =====================================================================
//
// Estrategia:
...
self.addEventListener('activate', event => {
  ...
  event.waitUntil(
    ...
    .then(() => {
      ...
      // recargar la pestaña automáticamente.
