...
const CACHE_NAME = 'ri5-v425'; // 🔥 FIX: selección por grupos + individual en Paso 3 de sesiones/packs (session-invites.js)
...
console.log('[SW] sw.js cargado correctamente (v425)');