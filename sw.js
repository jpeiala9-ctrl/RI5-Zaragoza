...
// Versión: 3.22 - Bump de caché (v262 -> v263): session-invites.js -- en
//                el Paso 3 se quita la etiqueta "📁 GRUPOS" y el botón
//                "✏️ GESTIONAR"; ahora es un único "GESTIONAR GRUPOS"
//                centrado con letras de título. En el modal de gestión,
//                cada grupo pierde el icono de carpeta y su nombre queda
//                centrado en la tarjeta.
// =====================================================================

const CACHE_NAME = 'ri5-v263';
...
console.log('[SW] sw.js cargado correctamente (v263)');
