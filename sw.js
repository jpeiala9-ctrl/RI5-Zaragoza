...
// Versión: 3.32 - Bump de caché (v272 -> v273): index.html -- el aviso en
//                rojo de fuerza (v272) usaba `var(--zone-5)`, que en la
//                paleta de esta app es un gris apagado (#9AA5A5, el color
//                de la zona 5 de FC), no rojo -- por eso no llamaba la
//                atención como se pretendía. Cambiado al rojo real que ya
//                usa esta misma tarjeta para "alerta" (#E74C3C, el mismo
//                de la barra de recuperación baja y el TSS alto). El
//                comportamiento de que el aviso desaparece solo al llegar
//                al 100% de recuperación ya funcionaba correctamente
//                (la tarjeta se re-pinta sola cada 5 minutos mientras la
//                app está abierta, ver el setInterval junto a esta
//                función) -- no hacía falta tocar esa parte.
// Versión: 3.31 - Bump de caché (v271 -> v272): index.html -- la
//                aclaración de la tarjeta "Carga y recuperación" del
//                Dashboard para sesiones de fuerza pasa a su propia línea
//                en rojo/negrita (antes iba pegada al texto normal en gris,
//                pasaba desapercibida). Además, el texto ya no da a
//                entender que correr no tiene NINGÚN efecto tras hacer
//                fuerza -- aclara que si la sesión trabajó piernas, sí
//                puede notarse (fatiga muscular local), aunque no bloquee
//                salir a correr.
...
console.log('[SW] sw.js cargado correctamente (v273)');
