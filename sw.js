...
// Versión: 3.79 - Bump de caché (v337 -> v338): index.html, guia.html --
//                Landing y guía actualizadas con el modo entrenador: la
//                tarjeta "Entrenador personal" del landing ahora explica
//                también el lado de enviar/gestionar atletas (no solo el
//                de recibir sesiones), y la guía suma un tema nuevo "Modo
//                entrenador" explicando cómo crear y enviar sesiones a tus
//                atletas y llevar el historial de a quién le mandaste qué.
// Versión: 3.78 - Bump de caché (v336 -> v337): app.js -- FIX visual en la
//                pestaña "Administración" del perfil de admin: se quita el
//                emoji "🛠️" (se renderizaba en modo color-emoji, más alto
//                que los iconos de texto de sus 3 pestañas vecinas, y
//                desalineaba la fila) y el texto pasa a pintarse con el
//                color de nivel propio del admin en vez de un icono.
