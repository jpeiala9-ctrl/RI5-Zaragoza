...
// Versión: 3.07 - Bump de caché (v247 -> v248): en "Generar sesión"
//                (admin), Paso 1: el título de cada paso (calentamiento/
//                parte principal/enfriamiento/extras) ya tiene su propia
//                fila y no se corta en palabras largas de una sola pieza.
//                Paso 3: cada usuario muestra su foto de perfil real en
//                el redondel (antes solo la inicial), y hay un contador
//                de seleccionados fijo en la cabecera, visible aunque se
//                baje por la lista.
// =====================================================================

const CACHE_NAME = 'ri5-v248';
