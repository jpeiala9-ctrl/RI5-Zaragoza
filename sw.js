...
// Versión: 3.15 - Bump de caché (v255 -> v256) para actualizar colores
//                ajustados (session-invites.js v12.6)
// =====================================================================

const CACHE_NAME = 'ri5-v256';
...
console.log('[SW] sw.js cargado correctamente (v256)');