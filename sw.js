...
// Versión: 2.68 - Bump de caché (v178 -> v179): calendar.js. Vuelve el
//                cuadro de "DATOS DE LA SESIÓN" al marcar como
//                realizada (solo km y tiempo, sin selector de tipo). FIX
//                calcularTSSdesdeReal: antes, si programabas 45' y
//                entrenabas 55' al mismo ritmo, la carga (TSS) se
//                quedaba anclada a los 45' planificados. Ahora toda la
//                duración real cuenta como parte principal, a la
//                zona/ritmo real que resulta de los km y el tiempo
//                introducidos, así que el tiempo de más (o de menos)
//                sí se refleja en la carga registrada. El flujo con GPS
//                no cambia: sigue siendo autosuficiente.
// Versión: 2.67 - Bump de caché (v177 -> v178): calendar.js. Al marcar
//                una sesión como realizada ya no se abre el modal
//                "DATOS DE LA SESIÓN" pidiendo confirmar/corregir km y
//                tiempo reales: se marca directamente con los datos
//                planificados (km, TSS y zona calculados a partir de lo
//                programado), igual que ya ocurría con descanso/fuerza y
//                al desmarcar. Las sesiones iniciadas con GPS no cambian:
//                siguen registrando sus datos reales medidos por el track.
