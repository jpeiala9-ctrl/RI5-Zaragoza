...
// Versión: 2.93 - Bump de caché (v233 -> v234): session-invites.js v8
//                corrige la animación "EN PROCESO" para que se complete
//                antes de mostrar la siguiente invitación.
// =====================================================================

const CACHE_NAME = 'ri5-v234';
