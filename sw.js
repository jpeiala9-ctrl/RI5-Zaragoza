...
//                friends.js y profile.js, que usaban el mismo patrón). De
//                paso: si un globalFeed viniera sin userId (dato suelto/
//                corrupto), ya no rompe toda la consulta -- se descarta
//                antes de construir el 'in'. Y la limpieza de amigos
//                huérfanos ahora es a prueba de fallos: si la comprobación
//                falla por lo que sea (red, etc.), se deja la lista de
//                amigos tal cual en vez de arriesgarse a borrar amigos
//                reales de Firestore por un error puntual. El modal de
//                "Sesiones hoy" (y el resto de listas del admin) también
//                enseña ahora el mensaje de error real si algo vuelve a
//                fallar, en vez de un texto genérico siempre igual.
...
console.log('[SW] sw.js cargado correctamente (v276)');
