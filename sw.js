      ...
      return fetch(event.request).then(response => {
        if (
          ...
          (url.origin === self.location.origin ||
           ...
           // 🔥 arcgisonline.com sustituye a basemaps.cartocdn.com como
           // proveedor de mosaicos de mapa (CartoDB empezó a exigir clave
           // de API) -- sin este cambio, los mosaicos del mapa dejarían
           // de guardarse para poder verse sin conexión.
