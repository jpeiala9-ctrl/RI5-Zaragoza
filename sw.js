...
// Versión: 4.23 - Bump de caché (v417 -> v418): index.html -- FIX: el
//                click en la notificación de Comunidad por un "me gusta"
//                ya redirigía a Perfil y centraba la sesión en el código
//                (ver AppState.entriesConLikesNuevos en app.js y el
//                listener de '.bottom-nav-item[data-tab]' en index.html),
//                pero ese cambio de index.html nunca llegó a incluirse en
//                un bump de CACHE_NAME -- el Service Worker (cache-first)
//                seguía sirviendo el index.html viejo (sin esa
//                redirección) a cualquiera que ya tuviera la app
//                instalada, así que al tocar la notificación seguía
//                abriendo Comunidad en vez de Perfil. Con este bump, el
//                index.html correcto por fin se descarga y se cachea.
...
const CACHE_NAME = 'ri5-v423'; // 🔥 FIX: index.html nunca se había bumpeado para la redirección de la notificación de "me gusta" a Perfil
