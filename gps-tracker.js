// ==================== gps-tracker.js ====================
// Versión: 3.16 - Completo, sin omisiones. Botón SIGUIENTE se convierte en FINALIZAR grande al final.
// ====================
    ...
    ov.innerHTML = `
      ...
      <div id="gpsSessionScreen" style="flex:1;display:none;flex-direction:column;">
        ...
        <div style="background:#111;border-top:1px solid #222;padding:14px 16px 20px;flex-shrink:0;">
          ...
          <!-- SOLO DOS BOTONES: PAUSA y SIGUIENTE -->
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    if (wallEntryId) {
      await firebaseServices.db.collection('globalFeed').doc(wallEntryId).update({
        ...
        distancia: parseFloat(distKm.toFixed(3)), duration: Math.floor(elapsedMs / 60000)
      });
    }
  },
...
console.log('✅ GPS Tracker v3.16 - Completo, sin omisiones, botón SIGUIENTE se convierte en FINALIZAR grande');