// ==================== gps-tracker.js ====================
// Versión: 3.32 - Cuenta atrás con efecto boomerang y voz "a correr" (sin texto)
// ====================
  ...
  _startCountdown() {
    ...
    const interval = setInterval(() => {
      ...
      if (count > 0) {
        ...
        // Eliminar el overlay después de un breve retardo (para que se escuche la voz)
        setTimeout(() => {
          overlay.remove();
...
console.log('✅ GPS Tracker v3.32 - Cuenta atrás con efecto boomerang y voz "a correr"');