// ==================== gps-tracker.js ====================
// Versión: 2.34 - Pantalla pre‑lock limpia, GPS profesional, confirmación al terminar
// ====================
...
const GPSTracker = {
  ...
  // Filtro GPS mejorado: descarta primeras lecturas, exige precisión <10m y buffer de lecturas suficiente
  ...
  async _terminarSesion() {
    const confirmacion = confirm('¿Deseas terminar la sesión? Los datos no guardados se perderán.');
...
console.log('✅ GPSTracker v2.34 - Pre‑lock limpio, GPS profesional, confirmación al terminar');