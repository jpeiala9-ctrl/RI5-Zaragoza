// ==================== gps-tracker.js ====================
// Versión: 3.65 - Anti‑bloqueo mejorado, bandera como punta, centrado automático perfecto
// ====================
  ...
  async _requestWakeLock() {
    ...
    try {
      ...
      this._wakeLock.addEventListener('release', () => {
        console.log('Wake Lock liberado, intentando renovar en 1s...');
...
console.log('✅ GPS Tracker v3.65 - Anti‑bloqueo mejorado, bandera como punta, centrado automático perfecto');