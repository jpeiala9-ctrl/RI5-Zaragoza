// ==================== gps-tracker.js ====================
// Versión: 3.11 - Voz nativa del sistema (Siri en iOS, Google en Android)
// ====================
...
const GPSTracker = {
  ...
  // ===== VOZ NATIVA DEL SISTEMA (SIRI / GOOGLE) =====
  _speak(text) {
    ...
    utterance.rate = 0.92;             // Velocidad natural
    utterance.pitch = 1.0;
    utterance.volume = 1.0;
    // No seleccionamos voz específica: el sistema usará la predeterminada (Siri/Google)
    window.speechSynthesis.speak(utterance);
    console.log(`🗣️ Voz sistema: ${text}`);
  },
...
console.log('GPS Tracker v3.11 - Voz nativa del sistema (Siri en iOS, Google en Android)');