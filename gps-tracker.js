// ==================== gps-tracker.js ====================
// Versión: 2.16 - Corregido error planActualId, marcado automático 90%
// ====================
...
const GPSTracker = {
  ...
  // ========== INICIO CON PRE‑LOCK MANUAL (ahora con planId) ==========
  async iniciar(sesion, diaIndex, planId) {
    ...
    this.planId = planId;   // Guardamos el planId recibido
    this.trackPoints = [];
    this._rawBuffer = [];
  ...
  // ========== GUARDADO EN FIREBASE (con planId almacenado) ==========
  _getCurrentUser() {
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    // Priorizar this.planId, luego AppState, luego localStorage
    ...
    // Decidir si marcar (90% en distancia Y tiempo si existen)
    ...
    const marcar = (cumpleDist && cumpleDur); // Solo marca si ambos (si existen) cumplen
...
console.log('✅ GPSTracker v2.16 - Corregido error planActualId');