// ==================== gps-tracker.js ====================
// Versión: 2.5 - Vertical fix + guardado robusto
// ====================
...
const GPSTracker = {
  ...
  _crearPantalla() {
    ...
    ov.innerHTML = `
      <style>
        /* Ajustes para que en vertical se vean bien los botones */
        @media (orientation: portrait) {
          #gpsSessionScreen .map-container { flex: 0 0 45% !important; min-height: 200px; }
  ...
  async _confirmarFinalizar() {
    ...
    // Mostrar loading solo si Utils está definido
    try {
...
console.log('✅ GPSTracker v2.5 - Vertical fix + guardado robusto');