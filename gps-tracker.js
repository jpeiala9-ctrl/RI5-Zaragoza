// ==================== gps-tracker.js - Grabación de rutas con ortofoto IGN ====================
// Versión: 1.4 - Capa base de ortofoto del IGN (Instituto Geográfico Nacional de España)
// Atribución: © IGN España (CC BY 4.0)
// ====================
...
const GPSTracker = {
  ...
  async initMap(containerId, center = null) {
    ...
    const map = L.map(containerId, { attributionControl: false }).setView(center || [40.416775, -3.703790], 14);
    
    // Capa de ortofoto IGN (España)
    ...
    this.currentMap = map;
    console.log('✅ Mapa inicializado con ortofoto IGN');
    return map;
  },
