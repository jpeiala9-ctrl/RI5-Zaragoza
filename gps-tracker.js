// ==================== gps-tracker.js ====================
// Versión: 3.65 - DEFINITIVA: centrado automático perfecto + auto-bloqueo a 5s + toggle manual
// ====================
...
const GPSTracker = {
  ...
  _crearPantalla() {
    ...
    // Auto-bloqueo tras 5 segundos sin interacción
    ...
    // Función toggle: desbloquea si está bloqueado, bloquea manualmente si está desbloqueado
    const toggleLock = () => {
      if (!this._isUnlocked) {
        // DESBLOQUEAR
...
console.log('✅ GPS Tracker v3.65 - Auto-bloqueo a 5s y toggle manual (DESBLOQUEAR/BLOQUEAR)');