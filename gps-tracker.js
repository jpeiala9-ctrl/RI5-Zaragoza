// ==================== gps-tracker.js - Grabación de rutas con OpenStreetMap ====================
// Versión: 2.0 - OSM, marcadores sutiles, grabación estable
// ============================================================================
...
const GPSTracker = {
  ...
  async initMap(containerId, center = null) {
    ...
    this.currentMap = map;
    console.log('✅ Mapa inicializado con OpenStreetMap');
    return map;
  },
