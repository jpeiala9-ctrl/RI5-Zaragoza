// ==================== gps-tracker.js ====================
// Versión: 3.49 - Pitidos garantizados, AudioContext unificado, aviso anti-bloqueo en parte baja
// ====================
...
const GPSTracker = {
  ...
  // ===== ANTI-BLOQUEO (usa el mismo AudioContext) =====
      ...
      if (acc <= 5) {
        if (startBtn && startBtn.style.display !== 'block') {
          ...
          startBtn.onclick = async () => {
            // Asegurar AudioContext y reanudarlo (gesto de usuario)
...
console.log('✅ GPS Tracker v3.49 - Pitidos garantizados, AudioContext unificado, aviso anti-bloqueo en parte baja');