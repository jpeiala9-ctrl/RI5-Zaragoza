...
const GPSTracker = {
  ...
  _mostrarConfirm() {
    ...
    if (zonaSelectEl) zonaSelectEl.value = ''; // por si se cancela y se vuelve a finalizar en la misma sesión
    ...
    const actualizarZonaAuto = () => {
      ...
      if (zonaAutoOption) zonaAutoOption.textContent = zona ? `AUTO (${zona[0]} · ${zona[1]})` : 'AUTO';
