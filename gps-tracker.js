  ...
  _crearPantalla() {
    ...
    ov.innerHTML = `
      ...
      <div id="gpsConfirm" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0;background:var(--bg-primary);z-index:3000;flex-direction:column;align-items:center;justify-content:center;padding:30px;text-align:center;">
        ...
        <div style="margin:0 0 20px 0; width:100%; max-width:280px;">
          <label style="font-size:11px; color:var(--text-secondary); letter-spacing:0.5px; display:block; margin-bottom:8px;">¿Zona real de trabajo? (si hubo desnivel o fuiste más de pulso, corrígela)</label>
