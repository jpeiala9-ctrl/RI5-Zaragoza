// ==================== gps-tracker.js ====================
// Versión: 3.15 - Completo: evita puntos en estático, sin líneas falsas, modal sin saltos
// ====================
...
const GPSTracker = {
  ...
  _smoothAndSimplify(lat, lng, timestamp) {
    ...
    // Si no hay movimiento significativo, no añadir punto (ni actualizar el último)
      ...
      <div id="gpsSessionScreen" style="flex:1;display:none;flex-direction:column;">
        ...
        <div style="background:#111;border-top:1px solid #222;padding:14px 16px 20px;flex-shrink:0;">
          ...
          <div style="display:flex;gap:10px;">
            ...
            <button id="gpsFinishBtn" onclick="GPSTracker._mostrarConfirm()" style="flex:1;height:50px;border:1px solid #666;background:transparent;color:#aaa;border-radius:12px;font-size:14px;font-weight:bold;cursor:pointer;letter-spacing:1px;">FINALIZAR</button>
          </div>
...
console.log('✅ GPS Tracker v3.15 - Completo, sin líneas falsas en estático');