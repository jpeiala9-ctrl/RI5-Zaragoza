// ==================== gps-tracker.js - Grabación de rutas con Leaflet/OSM (capa satelital) ====================
// Versión: 1.3 - Cambiada la capa base a imágenes satelitales de ESRI
// ====================
...
const GPSTracker = {
  ...
  async initMap(containerId, center = null) {
    ...
    this.currentMap = map;
    console.log('✅ Mapa inicializado con capa satelital');
    return map;
  },
  ...
  async displayRoute(containerId, points, options = {}) {
    ...
    // Ajustar el zoom para que se vea más cerca
