// ==================== gps-tracker.js ====================
// Versión: 2.17 - Sin mensajes de 90%, marcado automático silencioso
// ====================
...
const GPSTracker = {
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    if (!planId) throw new Error('No se encontró planActualId (debes pasar el planId a GPSTracker.iniciar)');
...
console.log('✅ GPSTracker v2.17 - Sin mensajes de 90%, marcado automático silencioso');