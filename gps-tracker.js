// ==================== gps-tracker.js ====================
// Versión: 2.4 - Finalización asegurada con logs
// ====================
...
const GPSTracker = {
  ...
  _crearPantalla() {
    ...
    // Asignación manual de eventos (evita conflictos)
  ...
  async _confirmarFinalizar() {
    ...
    if (typeof Utils !== 'undefined') Utils.showLoading('Guardando sesión...');
    ...
    try {
      ...
      if (typeof Utils !== 'undefined') {
        Utils.hideLoading();
        Utils.showToast('❌ Error al guardar. Usa "SALIR SIN GUARDAR"', 'error', 5000);
      }
...
console.log('✅ GPSTracker v2.4 - Finalización asegurada');