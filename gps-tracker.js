// ==================== gps-tracker.js ====================
// Versión: 4.3 - Bandera SIEMPRE centrada (3s) + distancia exacta (solo puntos precisos)
// ====================
  ...
  _initMap(lat, lng) {
    ...
    try {
      ...
      const forceCenter = () => {
        ...
        // Si el usuario no ha interactuado en los últimos 3 segundos, centrar
        const now = Date.now();
...
console.log('✅ GPS Tracker v4.3 - Bandera siempre centrada (3s) + distancia exacta (solo precisión ≤ 15m)');