// ==================== gps-tracker.js ====================
// Versión: 3.13 - Pasa distancia y tiempo real a marcarSesionRealizada (COMPLETO)
// ====================
...
const GPSTracker = {
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    // MARCADO: pasamos los valores REALES (distancia en km, duración en ms)
    ...
    if (wallEntryId) {
      await firebaseServices.db.collection('globalFeed').doc(wallEntryId).update({
        ...
        duration:      Math.floor(elapsedMs / 60000)   // tiempo real en minutos
      });
    }
  },
...
console.log('GPS Tracker v3.13 - Pasa distancia y tiempo real a marcarSesionRealizada (COMPLETO)');