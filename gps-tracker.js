// ==================== gps-tracker.js ====================
// Versión: 3.25 - Completa: marcador inicio anillo blanco, movimiento real, UI completa
// ====================
...
const GPSTracker = {
  ...
  _smoothAndSimplify(lat, lng, timestamp) {
    ...
    // Calcular distancia y velocidad desde el último punto suavizado
  ...
  // Marcador de inicio tipo "donut blanco" (anillo vacío)
  _addStartMarker(lat, lng) {
    if (!this.map || !window.L) return;
    if (this.startMarker) this.startMarker.remove();
    const startIcon = window.L.divIcon({
      html: `<div style="width:24px;height:24px;border-radius:50%;border:3px solid #fff;background:transparent;box-shadow:0 0 0 2px rgba(0,0,0,0.3);"></div>`,
  ...
  // ===== PANTALLA COMPLETA (con todos los elementos visuales) =====
  _crearPantalla() {
    ...
    ov.innerHTML = `
      ...
      <div id="gpsSessionScreen" style="flex:1;display:none;flex-direction:column;">
        ...
        <div style="background:#111;border-top:1px solid #222;padding:14px 16px 20px;flex-shrink:0;">
          ...
          <!-- SOLO DOS BOTONES: PAUSA y SIGUIENTE (FINALIZAR aparece al final) -->
...
console.log('✅ GPS Tracker v3.25 - Completa: marcador inicio anillo blanco, movimiento real, UI completa');