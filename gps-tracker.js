// ==================== gps-tracker.js ====================
// Versión: 2.15 - GPS continuo, modal simple (Guardar/Salir sin guardar)
// ====================
...
const GPSTracker = {
  ...
  _crearPantalla() {
    ...
    ov.innerHTML = `
      ...
      <!-- Modal de confirmación (solo dos botones) -->
      <div id="gpsConfirm">
  ...
  // ========== MODAL DE CONFIRMACIÓN (solo advertencia de 90% si no se cumple) ==========
  _mostrarConfirm() {
    ...
    if (!cumple && warningMsg) {
      if (warningDiv) {
        ...
        warningDiv.innerText = warningMsg + 'El track se guardará pero la sesión NO se marcará automáticamente.';
      }
    } else {
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    // Decidir si marcar (solo si se alcanza el 90% en distancia O tiempo)
    ...
    const marcar = (cumpleDist && cumpleDur); // Ambas deben cumplirse si existen
...
console.log('✅ GPSTracker v2.15 - GPS continuo, modal simple, marcado automático al 90%');