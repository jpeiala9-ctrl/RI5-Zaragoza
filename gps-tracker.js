// ==================== gps-tracker.js ====================
// Versión: 3.55 - Marcador único: bandera a cuadros (sin punto blanco), centrado automático mejorado
// Basado en tu original v3.49
// ====================
...
const GPSTracker = {
  ...
  map:           null,
  polyline:      null,
  currentMarker: null,   // ← marcador móvil (bandera)
  startMarker:   null,
  leafletLoaded: false,
  ...
  _userMovedMap: false,
  _autoCentering: false,   // evita bucles en el centrado
  ...
  // ========== MAPA CON CENTRADO AUTOMÁTICO MEJORADO Y MARCADOR ÚNICO (BANDERA) ==========
  _initMap(lat, lng) {
    ...
    try {
      ...
      // Variables para el centrado automático (sin bucles)
      let timeoutId = null;
      const resetTimer = () => {
  ...
  // ===== PANTALLA COMPLETA (resto del código original sin cambios) =====
  _crearPantalla() {
...
console.log('✅ GPS Tracker v3.55 - Marcador único bandera 🏁, centrado automático sin bucles');