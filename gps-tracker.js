// ==================== gps-tracker.js ====================
// Versión: 3.29 - Cuenta atrás minimalista y más pequeña, coherente con el estilo de la app
// ====================
...
const GPSTracker = {
  ...
  // ===== LEAFLET (mapa claro, track dorado) =====
  _loadLeaflet() {
  ...
  // ===== CUENTA ATRÁS MINIMALISTA Y MÁS PEQUEÑA =====
  _startCountdown() {
    let count = 3;
...
console.log('✅ GPS Tracker v3.29 - Cuenta atrás minimalista y más pequeña');