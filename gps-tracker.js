// ==================== gps-tracker.js ====================
// Versión: 2.18 - GPS continuo, marcado automático 90% sin avisos, planId flexible
// ====================
...
const GPSTracker = {
  ...
  async iniciar(sesion, diaIndex, planId) {
    ...
    this.planId = planId;   // Recibido desde el plan
    this.trackPoints = [];
    this._rawBuffer = [];
  ...
  async _guardarYPublicar(distKm, elapsedMs) {
    ...
    // Marcado automático si se alcanza el 90% en todos los objetivos definidos
    ...
    const marcar = (cumpleDist && cumpleDur);
    ...
    if (marcar) {
      ...
      // No mostramos ningún toast de éxito para no molestar
    }
...
console.log('✅ GPSTracker v2.18 - Definitivo: GPS continuo, marcado 90% silencioso');