// ==================== gps-tracker.js ====================
// Versión: 3.70 - DEFINITIVA: bandera fija, anclada al centro, track detrás, auto-bloqueo 5s
// ====================
...
const GPSTracker = {
  ...
  // ========== FUNCIÓN CORREGIDA (devuelve siempre el punto, incluso si actualiza el último) ==========
...
console.log('✅ GPS Tracker v3.70 - Bandera fija, anclada al centro, track detrás, auto-bloqueo 5s');