// ==================== gps-tracker.js ====================
// Versión: 2.6 - Botón COMENZAR definitivamente funcional, cancelar operativo, sin emoticono
// ====================
...
const GPSTracker = {
  ...
  _initMap(lat, lng) {
    ...
    } catch (e) { console.warn('Error iniciando mapa Leaflet:', e); }
  },
  ...
  async iniciar(sesion, diaIndex) {
    ...
    // Asignar eventos después de que los elementos existan en el DOM
    setTimeout(() => {
...
console.log('✅ GPSTracker v2.6 - Botón COMENZAR funcional, cancelar operativo');