...
// Versión: 3.17 - CORREGIDO: Eliminadas llamadas redundantes a Profile.actualizarContadorAmigos
// ====================
...
const Friends = {
  ...
  async aceptarSolicitud(requestId, fromUid, toUid) {
    try {
      ...
      // ✅ ELIMINADO: Ya no es necesario llamar a Profile.actualizarContadorAmigos
      // El contador se actualizará automáticamente cuando el usuario visite la pestaña Perfil
