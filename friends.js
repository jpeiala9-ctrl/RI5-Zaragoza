...
// Versión: 3.22 - Añadido color dinámico al badge del nivel
// ====================
...
const Friends = {
  ...
  // Devuelve el color CSS para un nivel (misma lógica que en gamification.js)
  ...
  async cargarListaAmigos() {
    ...
    try {
      ...
      for (const amigo of amigos) {
        ...
        const badgeStyle = typeof color === 'string' && color.includes('linear-gradient')
          ? `background: ${color}; color: white; text-shadow: 0 0 2px black;`
          : `background: ${color};`;
