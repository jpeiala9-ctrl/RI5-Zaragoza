...
// Versión: 3.44 - Sanitización de profile para evitar errores en usuarios nuevos
// ====================
...
const Friends = {
  ...
  async aceptarSolicitud(requestId, fromUid, toUid) {
    // 🔒 VALIDACIÓN: solo el destinatario real puede aceptar
  ...
  async abrirModalAmigo(uid) {
    ...
    try {
      ...
      // ==================== SANEAMIENTO DE DATOS (corrige formatos incorrectos) ====================
...
console.log('✅ friends.js con sanitización de profile para evitar errores');