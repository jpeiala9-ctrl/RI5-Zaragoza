// ==================== friends.js - Gestión de amigos OPTIMIZADA (caché, lotes '__name__') ====================
// Versión: 3.28 - Completa: caché sessionStorage, limpieza de huérfanos, batch de niveles
// ====================

const Friends = {
  todosUsuariosPagination: { lastDoc: null, hasMore: true, loading: false },

  // ========== OBTENER NIVELES EN LOTES (USANDO '__name__') ==========
  ...
  // ========== CARGA PRINCIPAL DE AMIGOS (CON CACHÉ Y LIMPIEZA DE HUÉRFANOS) ==========
  async cargarListaAmigos(forceRefresh = false) {
    ...
    try {
      ...
      // Obtener datos completos de los amigos (ya sabemos que existen)
      const amigos = [];
      const chunksData = [];
      for (let i = 0; i < friendIds.length; i += 10) {
  ...
  // ========== EVENTOS Y SOLICITUDES (FORZAN REFRESCO) ==========
  initEventListeners() {
  ...
  // ========== EXPLORAR USUARIOS (CON PAGINACIÓN) ==========
