...
// Versión: 3.16 - CORREGIDO: contador de amigos sincronizado con perfil
// ====================
...
const Friends = {
  ...
  async aceptarSolicitud(requestId, fromUid, toUid) {
    try {
      ...
      // ✅ Actualizar contador de amigos en el perfil
      if (window.Profile && window.Profile.actualizarContadorAmigos) {
        await window.Profile.actualizarContadorAmigos();
      }
