// ==================== friends.js - Tarjeta de perfil de usuario acorde al resto de la app ====================
// Versión: 3.37 - Usa las mismas clases y estilos que el resto de la app (action-button, btn-amigo, etc.)
// ====================
...
const Friends = {
  ...
  // ---------- MODAL DE PERFIL DE USUARIO (ESTILO CONSISTENTE CON LA APP) ----------
  async abrirModalAmigo(uid) {
    try {
      ...
      // Título del modal: nombre del usuario
      ...
      const contenido = `
        <div style="background:var(--bg-card); border-radius:16px; border:1px solid var(--border-color); overflow:hidden;">
          <!-- Datos del usuario: nivel y zapatilla -->
      ...
      setTimeout(() => {
        // Reasignar eventos a los botones del modal
        ...
        // También asignar evento a las insignias (si quieres que muestren descripción)
