// ==================== friends.js - Gestión de amigos optimizada (lotes, caché, limpieza) ====================
// Versión: 3.24 - Caché sessionStorage 30s, lotes '__name__' para niveles y limpieza
// ====================

const Friends = {
  todosUsuariosPagination: { lastDoc: null, hasMore: true, loading: false },

  // ---------- MÉTODOS DE GAMIFICACIÓN OPTIMIZADOS ----------
  ...
  async cargarListaAmigos(forceRefresh = false) {
    ...
    try {
      ...
      // Limpiar huérfanos (usando lotes)
      ...
      // Obtener datos de los amigos en lotes
      const amigosData = [];
      for (let i = 0; i < friendIds.length; i += 10) {
