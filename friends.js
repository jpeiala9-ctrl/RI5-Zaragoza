...
// Versión: 3.6 - Añadido botón de chat en lista de amigos
// ====================
...
const Friends = {
  ...
  // ========== FUNCIÓN GENÉRICA PARA CARGAR SOLICITUDES ==========
  async cargarSolicitudes(tipo) { // tipo: 'recibidas' o 'enviadas'
        ...
        html += `
          <div class="resultado-busqueda" style="justify-content:space-between;">
            ...
            <div style="display:flex; gap:8px;">
              <button class="btn-amigo" onclick="event.stopPropagation(); Chat.startChatWithFriend('${amigo.uid}', '${usernameFormatted}')">💬</button>
