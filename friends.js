...
// Versión: 3.45 - Manejo seguro de shoe.name, gamificación y profile
// ====================
  ...
  async abrirModalAmigo(uid) {
    ...
    try {
      ...
      try {
        ...
        console.warn('Error obteniendo gamificación, usando valores por defecto', e);
      }
      
      // 🔧 Protección adicional para shoe (zapatilla)
      ...
      try {
        ...
        console.warn('Error obteniendo zapatilla, usando valores por defecto', e);
      }
      
      const shoeName = (shoe.name && typeof shoe.name === 'string') ? shoe.name : 'Zapatilla actual';
      const shoeKm = (shoe.km && typeof shoe.km === 'number') ? shoe.km.toFixed(1) : '0.0';
...
console.log('✅ friends.js definitivo con protección total (shoe.name, gamificación, profile)');