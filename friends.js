// ==================== friends.js - Gestión de amigos (CON LIMPIEZA DE HUÉRFANOS + VISUALIZACIÓN DE GAMIFICACIÓN) ====================
// Versión: 3.16 - Al cargar perfil de amigo, muestra nivel, XP, racha e insignias
// ====================
...
const Friends = {
  ...
  // ==================== PERFIL DE AMIGO CON GAMIFICACIÓN ====================
    ...
    try {
      ...
      try {
        ...
        if (gamificationDoc.exists) {
          ...
          // Obtener nombres e iconos de las insignias (máximo 6 para no saturar)
        ...
        console.warn('Error cargando gamificación del amigo:', e);
      }
      // ================================================================
