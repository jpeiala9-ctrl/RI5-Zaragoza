// ==================== friends.js - Gestión de amigos con nivel directo y sin parpadeo ====================
// Versión: 3.21 - Obtiene niveles directamente de Firestore sin caché y los pinta directamente en el HTML
// ====================

const Friends = {
  todosUsuariosPagination: { lastDoc: null, hasMore: true, loading: false },

  // Obtiene el nivel de un usuario directamente desde Firestore (sin caché)
  ...
  // Obtiene niveles de múltiples usuarios en paralelo (sin caché)
  async getNivelesDirectos(uids) {
    const niveles = {};
    // Procesar en lotes de 10 para no saturar Firestore
  ...
  // ==================== LISTA DE AMIGOS CON NIVEL DIRECTO Y SIN PARPADEO ====================
  async cargarListaAmigos() {
    ...
    try {
      ...
      // Obtener niveles directamente (sin caché)
