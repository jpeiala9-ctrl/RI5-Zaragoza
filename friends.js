...
// Versión: 3.39 - Corregido: no mostrar botón "Agregar amigo" para el propio usuario.
// ====================
...
const Friends = {
  ...
  async enviarSolicitud(toUid, toUsername) {
    ...
    // No permitir enviarse solicitud a uno mismo
  ...
  async abrirModalAmigo(uid) {
    // CORRECCIÓN: Si es el propio usuario, mostrar un modal especial sin opciones de amistad
    if (uid === AppState.currentUserId) {
      ...
      // Para el propio usuario, mostrar un mensaje en lugar de botones de amistad
