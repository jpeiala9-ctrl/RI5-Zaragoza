// ==================== friends.js ====================
// Versión: 3.48 - Añadida función recargarTabGrupo() para actualizar el panel GRUPO
// ====================
...
const Friends = {
  ...
  // ============================================================
  // NUEVO: FORZAR RECARGA DEL TAB GRUPO (desde GroupSessions)
  // ============================================================
  recargarTabGrupo() {
    const grupoPanel = document.getElementById('amigos-grupo');
    if (grupoPanel && grupoPanel.classList.contains('active')) {
      // Usar un pequeño retraso para asegurar que la actualización de Firestore se ha completado
      setTimeout(() => {
        this.cargarSesionesGrupo();
      }, 300);
    }
  }
};
...
console.log('✅ friends.js v3.48 - Añadida función recargarTabGrupo()');