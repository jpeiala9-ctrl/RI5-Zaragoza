// ==================== friends.js - OPTIMIZADO (lotes, caché, limpieza de huérfanos) ====================
// Versión: 3.30 - Completo y funcional
// ====================

const Friends = {
  todosUsuariosPagination: { lastDoc: null, hasMore: true, loading: false },

  // Obtener niveles en lotes de 10 usando __name__
  ...
  // ========== NUEVO MÉTODO CARGAR LISTA DE AMIGOS (CON CACHÉ Y LIMPIEZA DE HUÉRFANOS) ==========
  async cargarListaAmigos(forceRefresh = false) {
    ...
    try {
      ...
      // Limpieza de amigos huérfanos con lotes '__name__'
