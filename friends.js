  ...
  async buscarUsuarios() {
    ...
    try {
      ...
      for (const user of result.items) {
        if (user.uid === AppState.currentUserId) continue; // No mostrarse a sí mismo
        ...
        // Avatar por defecto (siempre el mismo)
      ...
      container.innerHTML = '<p style="text-align:center; color:var(--zone-5);">Error en la búsqueda</p>';
    } finally {
      Utils.hideLoading();
    }
  },
