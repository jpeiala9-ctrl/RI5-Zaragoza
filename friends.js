...
// Versión: 3.45 - PAGINACIÓN CLÁSICA (20 usuarios por página, no acumulación)
// ====================
...
const Friends = {
  ...
  _renderExplorarUsuariosPaginado({ users, niveles, friendIds, enviadas, recibidas, pagina }) {
    const container = document.getElementById('todosUsuariosList');
    if (!container) return;
