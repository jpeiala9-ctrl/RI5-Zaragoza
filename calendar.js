...
// Versión: 2.28 - Añadida función validarOpcionesPlan
// ============================================================================
...
const PlanGenerator = {
  ...
  obtenerFaseSemana(fases, semanaGlobal) {
    ...
    // Si no se encuentra, devolver la última fase por defecto
  ...
  // ========== VALIDACIÓN DE OPCIONES DEL PLAN (NUEVA) ==========
  validarOpcionesPlan() {
    const distancia = document.getElementById("distObjetivo")?.value;
...
console.log('✅ PlanGenerator v2.28 - Refactorizado con helpers unificados');