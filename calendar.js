...
const PlanGenerator = {
  ...
  // ==========================================================================
  // FUNCIÓN PARA CALIBRAR NIVEL SEGÚN TIEMPO REAL (ya no se usa, se mantiene por compatibilidad)
  // ==========================================================================
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      // Calibración eliminada (campo mejorTiempo quitado)
  ...
  // ==========================================================================
  // FUNCIÓN PARA MOSTRAR/OCULTAR EL CUESTIONARIO (NUEVO)
  // ==========================================================================
  toggleCuestionario() {
