...
// Versión: 2.57 - Mapa aéreo IGN, cuenta atrás GPS, marcado forzado naranja
// ============================================================================
...
const PlanGenerator = {
  ...
  renderizarPagina(sesiones, semanasTotales) {
    ...
    for (let pos = 0; pos < celdas.length; pos++) {
      ...
      let claseAdicional = realizada ? (forzada ? 'realizado-forzado' : 'realizado') : '';
      let faseColor = '';
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON MAPA AÉREO Y BOTÓN NARANJA ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== CONTROLES DE GPS CON MAPA AÉREO Y BOTÓN NARANJA ==========
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          L.tileLayer('https://www.ign.es/wmts/mapa-raster?request=GetTile&service=WMTS&version=1.0.0&layer=OI.OrthoimageCoverage&style=default&tilematrixset=GoogleMapsCompatible&tilematrix={z}&tilerow={y}&tilecol={x}&format=image/jpeg', {
  ...
  // Mostrar ruta con mapa aéreo IGN
  ...
  // ========== FUNCIONES DE FEEDBACK Y MARCADO NORMAL ==========
...
console.log('✅ PlanGenerator v2.57 - Mapa aéreo IGN, cuenta atrás, marcado forzado naranja');