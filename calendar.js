// ==================== calendar.js - VERSIÓN SIN PULSACIONES ====================
// Versión: 2.38 - Eliminadas todas las referencias a FC y corazón en las explicaciones
// ============================================================================
...
const PlanGenerator = {
  ...
  async crearSesionBasica(tipo, fase, semanaEnFase, nivel, datos, factorVolumen, factorIntensidad, duracionExacta = null, esRecuperacion = false) {
    ...
    // PULSACIONES ELIMINADAS: fcObjetivo siempre vacío
    let fcObjetivo = '';
  ...
  async crearSesionAvanzadaSeries(estructura, fase, semanaEnFase, nivel, datos, factorVolumen, factorIntensidad, duracionExacta) {
    ...
    const datosBasicos = {
      ...
      ritmoObjetivo: this.obtenerRitmoParaZona('Z5'), fcObjetivo: '', // Pulsaciones eliminadas
  ...
  crearSesionSimulacion(fase, semanaEnFase, nivel, datos, duracionExacta) {
    ...
    const detalle = {
      ...
      fcObjetivo: '', // Pulsaciones eliminadas
  ...
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      `;
      // Zonas HTML sin el corazón ni FC
      const zonasHTML = `
...
console.log('✅ PlanGenerator v2.38 - Eliminadas todas las referencias a FC y corazón');