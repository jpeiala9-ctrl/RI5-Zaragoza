// ==================== calendar.js - VERSIÓN CON GPS INTEGRADO ====================
// Versión: 2.51 - Añadido soporte para grabación de rutas GPS
// ============================================================================
    ...
    try {
      ...
      if (realizada) {
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          // Obtener la ruta GPS si ya se había guardado antes (por ejemplo, si se grabó antes de marcar)
          let gpsRoute = null;
          ...
          const entry = {
            ...
            gpsRoute: gpsRoute  // Añadir ruta GPS si existe
          };
          try {
...
console.log('✅ PlanGenerator v2.51 - con GPS integrado');