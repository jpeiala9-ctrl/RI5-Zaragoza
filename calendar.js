// ==================== calendar.js - VERSIÓN COMPLETA 2.58 ====================
...
const PlanGenerator = {
  ...
  // ========== ABRIR DETALLE DE SESIÓN (CON BOTÓN GPS PASANDO PLANID) ==========
  ...
  // ==================== FUNCIÓN PRINCIPAL DE MARCADO (ACTUALIZADA v2.58) ====================
      ...
      if (debePublicar) {
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          if (window.Gamification && tipo === 'completo') {
            ...
            // Si es parcial con GPS, refrescar muro igualmente
            if (document.getElementById('tab-muro')?.classList.contains('active') && window.Wall)
              await Wall.cargarMuro();
          }
        }
...
console.log('✅ PlanGenerator v2.58 - Marcado naranja en calendario, GPS con planId, muro con datos completos');