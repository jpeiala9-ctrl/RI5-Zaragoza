...
const PlanGenerator = {
      ...
      pasosDetallados = [
        {
          ...
          accion: `${calentamiento}' de carrera muy suave (Z1)`,
          porque: 'Activar sistema cardiovascular, elevar temperatura muscular y preparar articulaciones.'
        },
        {
          icono: '💪',
          titulo: 'SERIES',
          accion: `${tiempoSeries}' de series: ${sesionMatriz.repeticiones} x ${sesionMatriz.distanciaSerie}m`,
          porque: 'Mejorar potencia aeróbica, velocidad y capacidad de eliminar lactato.'
        },
        {
          icono: '🧘',
          titulo: 'ENFRIAMIENTO',
          accion: `${enfriamiento}' de trote suave (Z1) seguido de estiramientos`,
          porque: 'Facilitar la vuelta a la calma, eliminar desechos metabólicos y prevenir lesiones.'
        }
      ];
    } else {
  ...
  renderizarPagina(sesiones) {
    ...
    for (let pos = 0; pos < celdas.length; pos++) {
      ...
      // MODIFICACIÓN: mostrar tiempo en lugar del día de la semana
      let contenidoHtml = '';
