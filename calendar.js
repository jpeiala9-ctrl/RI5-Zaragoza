    ...
    if (extrasPlanMin > 0) {
      ...
      if (totalPlanSub > 0) {
        ...
        subBloques.forEach(b => {
          ...
          const bloque = { min: mainMinProgramado * prop, km: mainKmProgramado * prop, zona: b.zona };
      ...
      if (plannedMainMin > 0 && plannedRecSec > 0) {
        ...
        if (sobranteMin > 0) {
          ...
          if (recMin > 0 && recMin < mainMinProgramado) {
            ...
            const recKm = mainKmProgramado * (recMin / mainMinProgramado);
            const esfuerzoKm = mainKmProgramado - recKm;
