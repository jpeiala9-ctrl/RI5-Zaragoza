...
console.log('✅ PlanGenerator v2.62 - Tirada larga: se alarga en vez de recortar, generada de una vez (sin parches posteriores) y con topes por tipo coherentes entre sí');