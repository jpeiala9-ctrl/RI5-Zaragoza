...
// Versión: 2.37 - CORREGIDO: tempo/series nunca superan la tirada larga
// ============================================================================
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      for (let semanaGlobal = 1; semanaGlobal <= semanasTotales; semanaGlobal++) {
        ...
        // ===== VALIDACIÓN: tempo y series no pueden superar a la tirada larga =====
  ...
  // ========== LIMPIEZA AUTOMÁTICA DEL MURO (SOLO ENTRADAS DEL DÍA ACTUAL) ==========
  ...
  // ========== MARCAR SESIÓN REALIZADA (CON MURO Y LIMPIEZA AUTOMÁTICA) ==========
  async marcarSesionRealizada(diaIndex, realizada) {
    ...
    try {
      ...
      // ========== GESTIÓN DEL MURO GLOBAL (SIN MODALES) ==========
      if (realizada) {
        // Primero, limpiar entradas antiguas de otros días
...
// Limpieza inicial del muro al cargar la página (solo si hay usuario y Firebase listo)
setTimeout(() => {
...
console.log('✅ PlanGenerator v2.37 - Corregido: tempo/series nunca superan la tirada larga');