...
// Versión: 2.48 - Integración completa con GPSTracker v2.23: marcado naranja/verde, track en muro
// ============================================================================
...
const PlanGenerator = {
  ...
  async marcarSesionRealizada(diaIndex, realizada, tipo = 'completo', trackPoints = null, gpsDistance = null) {
    if (!AppState.currentUserId || !AppState.planActualId) return;
    try {
      const planRef = firebaseServices.db
        .collection('users')
      ...
      // Solo publicar en muro y gamificación si es completo y realizada
      if (realizada && tipo === 'completo') {
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          const entry = {
            ...
            hasGPS: (trackPoints !== null && trackPoints.length > 0),
            trackPoints: (trackPoints !== null) ? trackPoints : [],
            gpsDistanceKm: (gpsDistance !== null && gpsDistance > 0) ? gpsDistance : null,
            gpsDurationMs: null
          };
...
console.log('✅ PlanGenerator v2.48 - Integración completa con GPSTracker v2.23');