// ==================== calendar.js - VERSIÓN CON MAPA VISIBLE Y GPS EN TIEMPO REAL ====================
// Versión: 2.56 - Mapa creado manualmente con Leaflet, marcador de ubicación y ruta en tiempo real
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON GPS MEJORADO (MAPA VISIBLE) ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== CONTROLES DE GPS CON MAPA VISIBLE Y CUENTA ATRÁS ==========
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          // Crear mapa con la ubicación obtenida (o coordenadas por defecto)
          ...
          watchId = navigator.geolocation.watchPosition(
            (pos) => {
              ...
              updateRoute();
              // Mover el marcador a la última posición
              userMarker.setLatLng([newPoint.lat, newPoint.lng]);
              // Centrar el mapa en la nueva posición (opcional)
  ...
  // ========== FUNCIÓN PARA MOSTRAR CUENTA ATRÁS CON OBTENCIÓN DE POSICIÓN PRECISA ==========
  _mostrarCuentaAtrasGPS() {
    return new Promise((resolve) => {
      // Crear overlay para la cuenta atrás
  ...
  // El resto de funciones (guardarFeedback, marcarSesionRealizada, etc.) se mantienen igual...
  // (incluye todas las funciones que ya tenías)
  ...
  async marcarSesionRealizada(diaIndex, realizada) {
    // ... (código existente, pero debe estar completo)
  },
...
console.log('✅ PlanGenerator v2.56 - Mapa visible, cuenta atrás, ruta en tiempo real');