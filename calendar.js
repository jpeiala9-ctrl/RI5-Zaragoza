...
// Versión: 5.4 - PERSISTENCIA COMPLETA DEL PLAN ACTIVO
// ============================================================================
...
const PlanGenerator = {
  ...
  async mostrarUltimoPlanGuardado() {
    ...
    try {
      ...
      AppState.guardarPlanActivo(ultimoPlanId);
      
      AppState.sesionesRealizadas = await Storage.getSesionesRealizadas(AppState.currentUserId, ultimoPlanId) || {};
...
console.log('✅ PlanGenerator v5.4 - Persistencia completa del plan activo');