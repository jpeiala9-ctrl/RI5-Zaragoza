...
// Versión: 2.51 - Añadido botón "Invitar a amigos" en detalle de sesión
// ============================================================================
...
const PlanGenerator = {
  ...
  // ============================================================
  //  ABRIR DETALLE DE SESIÓN (con botón "Invitar a amigos")
  // ============================================================
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== BOTÓN INVITAR A AMIGOS (NUEVO) ==========
      if (AppState.currentUserData?.friendIds?.length > 0 && typeof GroupSessions !== 'undefined') {
        const shareBtn = document.createElement('button');
        shareBtn.textContent = '👥 Invitar a amigos';
        shareBtn.style.cssText = [
          'margin-top:10px', 'width:100%', 'height:48px',
          'background:transparent',
          'border:1px solid #9BB5A0',
          'color:#9BB5A0',
          'border-radius:10px',
        ...
        shareBtn.onclick = async () => {
          await GroupSessions.mostrarSelectorAmigos(sesion, diaIndex);
        };
...
console.log('✅ PlanGenerator v2.51 - Añadido botón "Invitar a amigos"');