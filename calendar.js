...
// Versión: 2.65 - Fix: ordenar sesiones por diaGlobal al cargar el calendario
//                para que el índice coincida con el día real y el táctil abra
//                la sesión correcta.
// ============================================================================
...
const PlanGenerator = {
  ...
  // Usa this._sesionesActuales ordenado para obtener la sesión correcta por índice.
  renderizarMes() {
    const grid = document.getElementById("calendarioGrid");
    ...
    // 🔥 LISTENER CORREGIDO: usa this._sesionesActuales en lugar de la variable local
    document.querySelectorAll('.calendario-dia[data-dia-global]').forEach(diaEl => {
      diaEl.addEventListener('click', (e) => {
        ...
        // Usar el array ordenado this._sesionesActuales
        const sesion = this._sesionesActuales[diaGlobal - 1];
