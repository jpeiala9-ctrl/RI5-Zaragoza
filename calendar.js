// ============================================================================
// calendar.js - VERSIÓN ÉLITE 2.4
// Fuerza como complemento en días de rodaje (sin reemplazar sesiones)
// ============================================================================
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      for (let semanaGlobal = 1; semanaGlobal <= semanasTotales; semanaGlobal++) {
        ...
        // Asignar resto de tipos (rodaje, tempo, series)
...
console.log('✅ PlanGenerator v16.4 - Fuerza como complemento en días de rodaje');