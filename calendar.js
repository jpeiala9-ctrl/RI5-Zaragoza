  ...
  abrirModalDatosReales(sesion) {
    return new Promise((resolve) => {
      ...
      modal.innerHTML = `
        ...
        <div id="datosRealesZonaBox" style="background:var(--bg-primary); border:1px solid var(--border-color); border-left:4px solid transparent; border-radius:12px; padding:12px; margin-bottom:12px; transition:border-color .2s ease;">
        ...
        <div style="margin-bottom:18px;">
          <label style="display:block; font-size:11px; color:var(--text-secondary); letter-spacing:0.5px; margin-bottom:6px;">¿Zona real de trabajo? (si hubo desnivel o fuiste más de pulso, corrígela)</label>
      ...
      // 🔥 Corrección manual de zona: null = automática (por ritmo, como
      // antes). El ritmo medio no distingue un llano de una sesión con
      // desnivel o con el pulso más alto de lo normal -- aquí se puede
      // decir "en realidad esto fue Z3/Z4", y esa zona (no la calculada)
      // es la que se usa luego para guardar la sesión y recalcular el TSS.
