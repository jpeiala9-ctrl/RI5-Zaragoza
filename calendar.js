// ==================== calendar.js - VERSIÓN CON CUENTA ATRÁS GPS Y MAPA FIJO ====================
// Versión: 2.55 - Cuenta atrás visual de 5 segundos, mejora de precisión, mapa estable
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON GPS + CUENTA ATRÁS VISUAL ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== CONTROLES DE GPS CON CUENTA ATRÁS VISUAL ==========
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          // Mostrar modal de cuenta atrás y obtener posición precisa
          ...
          GPSTracker.onTrackingEnd = async (routeData) => {
            ...
            if (routeData.points.length >= 2) {
              ...
              if (typeof GPSTracker.displayRoute === 'function') {
                await GPSTracker.displayRoute('gpsMapContainer', routeData.points);
              }
            } else {
              Utils.showToast('Puntos insuficientes', 'warning');
            }
          ...
          // Iniciar grabación con la posición precisa ya obtenida
  ...
  _mostrarCuentaAtrasGPS() {
    return new Promise((resolve) => {
      ...
      // Iniciar watchPosition para obtener la mejor precisión durante los 5 segundos
      watchId = navigator.geolocation.watchPosition(
        (pos) => {
          ...
          if (accuracy < bestAccuracy) {
            ...
            console.log(`📍 Mejor precisión: ${accuracy} m`);
          } else {
        ...
        (err) => {
          ...
          precisionSpan.innerText = `⚠️ Error GPS: ${err.message}. Usando última posición.`;
        },
      ...
      // Si no se obtiene ninguna posición en 5 segundos, se usa la última conocida (null)
      setTimeout(() => {
...
console.log('✅ PlanGenerator v2.55 - GPS con cuenta atrás visual, mapa estable');