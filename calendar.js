...
// Actualización: cuenta atrás de 5s antes de iniciar grabación GPS
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON GPS (MEJORADA CON CUENTA ATRÁS) ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== CONTROLES DE GPS CON CUENTA ATRÁS ==========
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          // 1. Obtener posición precisa con alta precisión
          ...
          try {
            ...
            precision = posicionPrecisa.coords.accuracy;
          ...
          // 2. Verificar precisión (si > 30m, avisar)
          if (precision && precision > 30) {
            Utils.showToast(`⚠️ Precisión baja (${precision} m). La ruta puede ser poco precisa.`, 'warning', 3000);
          ...
          // 3. Cuenta atrás de 5 segundos
          Utils.showToast('✅ Precisión aceptable. Comenzando en 5 segundos...', 'success', 2000);
          
          // Mostrar cuenta atrás progresiva
          for (let i = 5; i > 0; i--) {
            Utils.showToast(`⏱️ Grabación comenzará en ${i} segundo${i !== 1 ? 's' : ''}...`, 'info', 1000);
            await new Promise(resolve => setTimeout(resolve, 1000));
          }
          
          // 4. Crear contenedor del mapa
...
console.log('✅ PlanGenerator v2.53 - con GPS, cuenta atrás de 5s, verificación de precisión y mapa satelital');