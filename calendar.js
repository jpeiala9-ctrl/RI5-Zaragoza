  ...
  renderizarMes() {
    ...
    for (let dia = 1; dia <= totalDiasMes; dia++) {
      ...
      if (!sesion) {
        ...
        // 🔥 "+" para registrar un entreno no programado: solo en días
        // dentro del plan que SIGUEN sin sesión asignada, y solo hoy o en
        // el pasado (no tiene sentido registrar un entreno de un día que
        // aún no ha llegado).
        const sePuedeRegistrar = dentroDelPlan && fecha <= hoy;
