...
// Versión: 4.2 - DEFINITIVA CON CORRECCIÓN DE FC POR ZONA
//
// CARACTERÍSTICAS:
...
const PlanGenerator = {
  ...
  calcularMetricasSesion(sesion) {
    ...
    // Rangos de FC coherentes con training.js
    const fcRangos = {
    ...
    partes.forEach(parte => {
      ...
      // Formato de FC: para Z6 mostramos "> límite inferior", para el resto rango
      let fcRange = '';
      if (zona === 'Z6') {
...
console.log('✅ PlanGenerator v4.2 - Rangos de FC coherentes con zonas');