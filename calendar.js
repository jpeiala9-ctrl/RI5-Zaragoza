...
// Versión: 2.47 - Guarda el estado del plan al generarlo
// ============================================================================
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      // Guardar el estado del plan para persistencia
...
console.log('✅ PlanGenerator v2.47 - Guarda el estado del plan al generarlo');