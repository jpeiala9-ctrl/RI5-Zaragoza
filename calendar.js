...
// Versión: 2.40 - Muro corregido (eliminada limpieza automática, forzada recarga)
// ============================================================================
...
const PlanGenerator = {
  ...
  // ✅ FUNCIÓN CORREGIDA - Limpieza de entradas de más de 30 días
  ...
  // ✅ FUNCIÓN CORREGIDA - Marcar sesión y guardar en muro
  async marcarSesionRealizada(diaIndex, realizada) {
    ...
    try {
      ...
      if (realizada) {
        // ✅ ELIMINADO: await this.limpiarMuroGlobal(); - No borrar antes de guardar
...
console.log('✅ PlanGenerator v2.40 - Muro corregido (limpieza 30 días, recarga forzada)');