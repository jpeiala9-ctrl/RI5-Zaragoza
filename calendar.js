// ==================== calendar.js - VERSIÓN COMPLETA 2.63 ====================
// Calendario siempre verde, parciales suman a gamificación, ritmo medio corregido
// ============================================================================
    ...
    try {
      ...
      if (debePublicar) {
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          let ritmoMedio = null;
          // Solo calcular ritmo si la distancia es suficiente y el valor es razonable
          if (tieneGPS && gpsDistance > 0.1 && sesion.duracion) {
            const ritmoSeg = (sesion.duracion * 60) / gpsDistance;
            if (ritmoSeg < 1200) { // menos de 20 min/km
          ...
          // Eliminamos el campo zapatillas (no se mostrará en el muro)
          const entry = {
...
console.log('✅ PlanGenerator v2.63 - Calendario siempre verde, parciales suman a gamificación, ritmo medio corregido');