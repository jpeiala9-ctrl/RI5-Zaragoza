...
// Versión: 2.44 - Exportación .FIT usando fit-writer.js externo
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN DE EXPORTACIÓN .FIT (usa FitWriter global definido en fit-writer.js) ==========
  exportarWorkoutAFIT(sesion) {
    ...
    try {
      ...
      // Usamos la clase FitWriter global (definida en fit-writer.js)
...
console.log('✅ PlanGenerator v2.44 - Exportación .FIT usando fit-writer.js externo');