...
// Versión: 2.47 - GPS integrado, sin fuerza, toast único
// ============================================================================
...
const PlanGenerator = {
  ...
  async marcarSesionRealizada(diaIndex, realizada, skipToast = false) {
    ...
    try {
      ...
      if (!skipToast) Utils.showToast(realizada ? '✅ Sesión marcada' : '📝 Sesión desmarcada (actualizada)', 'success');
    } catch (error) {
...
console.log('✅ PlanGenerator v2.47 - GPS tracking integrado, sin fuerza, toast único');