// ==================== calendar.js - VERSIÓN DEFINITIVA CON MAPA AÉREO ESRI ====================
// Versión: 2.63 - Mapa aéreo Esri World Imagery, cuenta atrás, marcado naranja sin recarga
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON MAPA AÉREO ESRI ==========
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          // Capa aérea de Esri World Imagery
...
console.log('✅ PlanGenerator v2.63 - Mapa aéreo Esri, cuenta atrás, marcado naranja sin recarga');