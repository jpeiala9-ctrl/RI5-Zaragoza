...
// Versión: 2.32 - Escape HTML en detalles de sesión y mejoras de seguridad
// ============================================================================
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      const zonasHTML = `
        <div class="sesion-zonas">
          ...
          <div class="zona-item"><span>❤️ FC</span><strong>${Utils.escapeHTML(sesion.detalle.fcObjetivo)}</strong></div>
...
console.log('✅ PlanGenerator v2.32 - Escape HTML en detalles de sesión');