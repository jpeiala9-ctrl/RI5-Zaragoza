...
// Versión: 3.4 - CORREGIDA (escalado conserva series sin minutos)
// 
// CARACTERÍSTICAS:
...
const PlanGenerator = {
  ...
  // ==========================================================================
  // FUNCIÓN DE ESCALADO PROPORCIONAL CORREGIDA
  // ==========================================================================
  escalarEstructura(estructura, duracionObjetivo) {
    ...
    for (let seg of segmentos) {
      ...
      if (match) {
        ...
        // Segmento sin minutos (ej: "3x5000m")
        partes.push({
          texto: seg,
          minutos: null          // indica que no se escala
        });
      }
    }
    ...
    // Si no hay partes con minutos, devolvemos la estructura original (o una por defecto)
    if (partesConMinutos.length === 0) {
      return estructura; // O podrías devolver `${duracionObjetivo}' continuos`
    }
...
console.log('✅ PlanGenerator v3.4 - CORREGIDO: Escalado conserva series sin minutos.');