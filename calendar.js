...
// Versión: 5.2 - CORREGIDA (problema de fases solucionado)
//
// CARACTERÍSTICAS:
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      const fases = this.definirFasesProfesionales(semanasTotales, objetivo);
  ...
  // ==========================================================================
  // FUNCIONES AUXILIARES DE PERIODIZACIÓN (CORREGIDAS)
  // ==========================================================================
  ...
  definirFasesProfesionales(semanasTotales, objetivo) {
    const fases = [];
    
    if (semanasTotales <= 4) { // 1 mes
      fases.push(
        { nombre: 'base', semanaInicio: 1, duracion: 2 },
        { nombre: 'construccion', semanaInicio: 3, duracion: 2 }
      );
    } else if (semanasTotales <= 12) { // 3 meses
      fases.push(
        { nombre: 'base', semanaInicio: 1, duracion: 4 },
        { nombre: 'construccion', semanaInicio: 5, duracion: 4 },
        { nombre: 'especifica', semanaInicio: 9, duracion: 4 }
      );
    } else if (semanasTotales <= 24) { // 6 meses
      fases.push(
        { nombre: 'base', semanaInicio: 1, duracion: 8 },
        { nombre: 'construccion', semanaInicio: 9, duracion: 8 },
        { nombre: 'especifica', semanaInicio: 17, duracion: 8 }
      );
    } else { // 12 meses
      fases.push(
...
console.log('✅ PlanGenerator v5.2 - Fases corregidas');