...
// Versión: 5.5 - Validación robusta del día de tirada larga + opción automática
//
// CARACTERÍSTICAS:
...
// - Día de tirada larga respetado estrictamente (con validación y selección automática)
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      if (diaLargoInput === 'auto') {
        // Elegir automáticamente el mejor día
        diaLargo = this.elegirDiaLargoOptimo(diasEntreno, modalidad, distancia, nivel);
        // Mostrar al usuario qué día se ha seleccionado (opcional, mejora UX)
  ...
  // ==========================================================================
  elegirDiaLargoOptimo(diasEntreno, modalidad, distancia, nivel) {
    // Prioridad 1: fin de semana (sábado o domingo)
    if (diasEntreno.includes(6)) return 6; // sábado
    if (diasEntreno.includes(7)) return 7; // domingo
    
    // Prioridad 2: el día con mayor número (último de la semana disponible)
    // Esto suele ser mejor para acumular fatiga antes del descanso
...
console.log('✅ PlanGenerator v5.5 - Con validación de día largo y opción automática');