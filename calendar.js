...
// Versión: 2.48 - Corregido error de carga de calendario y botón "Nuevo Plan"
// ============================================================================
...
const PlanGenerator = {
  ...
  toggleCuestionario() {
    // Mostrar un toast de carga para dar feedback visual
    ...
    if (cuestionario) {
      ...
      if (!isVisible) {
        // Si se está mostrando, asegurar que el calendario esté oculto
        const calendario = document.getElementById('calendarioEntreno');
        if (calendario) calendario.style.display = 'none';
      }
    } else {
      console.warn('No se encontró el elemento cuestionarioEntreno');
    }
  },
...
console.log('✅ PlanGenerator v2.48 - con GPS integrado y correcciones de carga');