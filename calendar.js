// ==================== calendar.js - VERSIÓN COMPLETA 2.59 ====================
// Siempre verde en calendario, texto "(parcial)" en detalle, publicación en muro con minimapa.
// ============================================================================
  ...
  renderizarPagina(sesiones, semanasTotales) {
    ...
    for (let pos = 0; pos < celdas.length; pos++) {
      ...
      if (estado && estado.realizada) {
        // Siempre verde, sin importar el tipo (completo o parcial)
...
console.log('✅ PlanGenerator v2.59 - Calendario siempre verde, texto "parcial" en detalle');