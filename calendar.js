// ============================================================================
// calendar.js - VERSIÓN CORREGIDA: RESPETA ESTRICTAMENTE LOS DÍAS ELEGIDOS
// ============================================================================
...
const PlanGenerator = {
  ...
  // ==========================================================================
  // GENERACIÓN PRINCIPAL (CORREGIDA)
  // ==========================================================================
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      for (let semanaGlobal = 1; semanaGlobal <= semanasTotales; semanaGlobal++) {
        ...
        // ==========================================================================
        // ASIGNACIÓN DE SESIONES A LOS DÍAS SELECCIONADOS (CORREGIDA)
        // ==========================================================================

        // Construimos un array con los tipos que tocan esta semana (sin el largo)
        ...
        // Mezclamos ligeramente para dar variedad
        ...
        // Construimos el objeto tiposPorDia: día -> tipo de sesión
        const tiposPorDia = {};
        ...
        for (let diaSemana = 1; diaSemana <= 7; diaSemana++) {
          ...
          // Si el día está en diasEntreno, obtenemos su tipo del mapa
...
console.log('✅ PlanGenerator v8.1 - CORREGIDO: respeta estrictamente los días elegidos por el usuario');