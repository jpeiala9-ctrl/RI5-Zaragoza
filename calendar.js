...
// Versión: 4.1 - DEFINITIVA CON CORRECCIONES DE PRECISIÓN
//
// CARACTERÍSTICAS:
...
const PlanGenerator = {
  ...
  // ==========================================================================
  // DETALLE DE SESIÓN (MODAL) - DISEÑO PROFESIONAL SIN SCROLL
  // ==========================================================================
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // Generar los pasos con diseño compacto
  ...
  calcularMetricasSesion(sesion) {
    ...
    partes.forEach(parte => {
      ...
      // Si no se detectó zona, usar la zona de la sesión (tomando la primera si es rango)
      if (!zona) {
        ...
        <div class="paso">
          ...
          <div class="paso-grid">
            <div class="paso-item">
              ...
              <span class="paso-valor">${paso.minutos}'</span>
            </div>
            <div class="paso-item">
              <span class="paso-icon">❤️</span>
              <span class="paso-valor">${paso.fc}</span>
            </div>
            <div class="paso-item">
              <span class="paso-icon">📈</span>
              <span class="paso-valor">${paso.zona}</span>
            </div>
            <div class="paso-item">
              <span class="paso-icon">🎯</span>
              <span class="paso-valor">${paso.ritmo}</span>
            </div>
            <div class="paso-item">
              <span class="paso-icon">📏</span>
              <span class="paso-valor">${paso.distancia.toFixed(2)}<small>km</small></span>
            </div>
          </div>
        </div>
      `;
...
console.log('✅ PlanGenerator v4.1 - Cálculo preciso de series y herencia de zonas');