...
const combined = new Uint8Array(def.length + 1 + payload.length);
combined.set(def);
combined[def.length] = 0x00;
combined.set(payload, def.length + 1);
...
return Math.min(value.length + 1, 64);
