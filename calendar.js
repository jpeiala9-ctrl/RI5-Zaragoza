// ==================== calendar.js - VERSIÓN FINAL 2.20 ====================
// - Corregido mínimo de duración de series (45 min en semanas normales)
// - Ajuste automático del volumen de series si es inferior a 45 min
// - Mejoras en el evento click del calendario (depuración)
// ============================================================================
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      for (let semanaGlobal = 1; semanaGlobal <= semanasTotales; semanaGlobal++) {
        ...
        // ===== CORRECCIÓN: Asegurar un mínimo de 45 minutos para series (excepto en taper) =====
  ...
  async crearSesionAvanzadaSeries(estructura, fase, semanaEnFase, nivel, datos, factorVolumen, factorIntensidad, duracionExacta) {
    ...
    switch(estructura) {
      ...
      case 'fartlek':
        ...
        const duracionCiclo = (tiempoFuerte + tiempoSuave) / 60;
      ...
      case 'cuestas':
        ...
        const recCuesta = 90;
        const duracionTotalCuestas = numCuestas * duracionCuesta;
...
console.log('✅ PlanGenerator v2.20 - Series con duración mínima de 45 min, ajuste automático y click mejorado');