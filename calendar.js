// ============================================================================
// calendar.js - VERSIÓN COMPLETA CON VALIDACIÓN POR NIVEL
// AVANZADO → mínimo 5 días obligatorios
// ============================================================================
...
const PlanGenerator = {
  ...
  validarOpcionesPlan() {
    ...
    else if (duracion === '1' && !['2k', '5k', '10k'].includes(distancia)) {
      infoDiv.style.display = 'block';
      infoDiv.innerHTML = '⚠️ Plan de 1 mes solo para 2km, 5km y 10km';
      generarBtn.disabled = true;
    }
    else if (['medio', 'maraton'].includes(distancia) && duracion === '3' && experiencia === 'no') {
      infoDiv.style.display = 'block';
...
console.log('✅ PlanGenerator v8.2 - COMPLETO: respeta tus días y valida nivel avanzado');