...
// Versión: 2.54 - Marcado naranja en calendario, botón GPS con planId, publicación en muro
// ============================================================================
...
const PlanGenerator = {
  ...
  // ==================== FUNCIÓN ABRIR DETALLE SESIÓN (CORREGIDA: BOTÓN GPS CON PLANID) ====================
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      if (window.GPSTracker) {
        ...
        // CORRECCIÓN: pasar AppState.planActualId como tercer parámetro
...
console.log('✅ PlanGenerator v2.54 - Marcado naranja en calendario funcionando, botón GPS con planId');