// ============================================================================
// calendar.js - VERSIÓN FINAL 2.13 (COMPLETA)
// - Paginación dinámica según duración real del plan
// - Pre‑cálculo de métricas para feed asegurado
// - Rodajes con variabilidad natural, tirada larga coherente, series con mínimo de repeticiones
// ============================================================================
      ...
      for (let semanaGlobal = 1; semanaGlobal <= semanasTotales; semanaGlobal++) {
        ...
        if (numDiasRodaje > 0 && minutosRodajeTotal > 0) {
          ...
          for (let i = 0; i < numDiasRodaje; i++) {
            let rangoSuperior = Math.min(maxRodaje, minutosRodajeTotal);
...
console.log('✅ PlanGenerator v2.13 - Versión completa (sin resúmenes)');