...
// Versión: 2.46 - Refresca perfil y amigos tras subir de nivel (con limpieza de caché)
// ============================================================================
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          if (window.Gamification) {
            try {
              ...
              // Si el nivel cambió, limpiar caché y refrescar UI
              if (newLevel !== oldLevel) {
                console.log(`🎉 Nivel cambiado de ${oldLevel} a ${newLevel}. Refrescando UI...`);
                // Limpiar caché de gamificación
...
console.log('✅ PlanGenerator v2.47 - GPS tracking integrado');