// ==================== calendar.js - VERSIÓN COMPLETA CON GPS SIMPLIFICADO ====================
// Versión: 2.54 - GPS directo sin toasts ni cuenta atrás, mapa con altura fija
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN ABRIR DETALLE CON GPS SIMPLIFICADO (SIN TOASTS NI CUENTA ATRÁS) ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // ========== CONTROLES DE GPS SIMPLIFICADOS (SIN TOASTS NI CUENTA ATRÁS) ==========
      if (!realizada) {
        ...
        startBtn.onclick = async () => {
          ...
          if (!mapContainer) {
            ...
            mapContainer.style.minHeight = '300px'; // Asegurar altura para que el mapa se vea
          ...
          GPSTracker.onTrackingEnd = async (routeData) => {
            ...
            if (routeData.points.length >= 2) {
              ...
              // Solo un toast final (opcional, puedes comentar las siguientes líneas)
              if (porcentaje <= 10) {
...
console.log('✅ PlanGenerator v2.54 - GPS directo sin toasts, con mapa visible');