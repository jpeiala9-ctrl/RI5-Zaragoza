...
// Versión: 2.40 - Añadidos zone y trainingName al muro
// ============================================================================
...
const PlanGenerator = {
  ...
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      // CORRECCIÓN: Mostrar la zona real de la sesión y el tiempo en zona solo si existe
      ...
      if (realizada) {
        ...
        if (sesion && sesion.detalle && sesion.tipo !== 'descanso') {
          ...
          const entry = {
            ...
            likes: [],
            likeCount: 0,
            zone: sesion.detalle.zona || '',              // ← añadido
            trainingName: sesion.detalle.nombre || ''     // ← añadido
          };
...
console.log('✅ PlanGenerator v2.40 - Muro con zone y trainingName');