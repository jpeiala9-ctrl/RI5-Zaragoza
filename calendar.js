...
// Versión: 2.41 - Exportación .FIT para relojes GPS
// ============================================================================
...
const PlanGenerator = {
  ...
  exportarWorkoutAFIT(sesion) {
    ...
    const fitLib = window['fitFileWriter'] || window['@markw65/fit-file-writer'];
    ...
    pasos.push({
      ...
      duracionSeg: partePrincipalSec,
      zona: extraerZona(sesion.detalle.zona),
      intensidad: 'active'
    });
    pasos.push({
      nombre: 'Enfriamiento',
