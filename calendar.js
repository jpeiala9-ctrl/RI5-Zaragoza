// ============================================================================
// calendar.js - VERSIÓN STABLE (SIN FECHA DE INICIO MANUAL)
// La fecha de inicio se calcula automáticamente como el próximo lunes.
// Se respeta el día de tirada larga elegido por el usuario.
// ============================================================================
...
const PlanGenerator = {
  ...
  // ==========================================================================
  // GENERACIÓN PRINCIPAL (SIN FECHA DE INICIO MANUAL)
  // ==========================================================================
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      // Validar que el día largo elegido esté marcado
      ...
      const planParaGuardar = {
        params: {
          ...
          fechaInicio: fechaInicio.toISOString()   // Guardamos la fecha de inicio real
        },
  ...
  // ==========================================================================
  // FUNCIONES AUXILIARES (sin cambios significativos, se mantienen)
  // ==========================================================================
  ...
  // ==========================================================================
  // CREAR SESIÓN DESDE MATRIZ (sin cambios, pero se mantiene por completitud)
  // ==========================================================================
...
console.log('✅ PlanGenerator v14.4 - Fecha inicio automática, día largo validado');