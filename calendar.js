// ============================================================================
// calendar.js - VERSIÓN ÉLITE 2.2 (corregida: sesionMatriz siempre definida)
// ============================================================================
...
const PlanGenerator = {
  ...
  async crearSesionDesdeMatriz(sesionBase, esActivo, fase, semanaEnFase, nivel, datos, factorVolumen, factorIntensidad, duracionExacta = null) {
    ...
    // ========== CORRECCIÓN: Siempre obtener sesionMatriz ==========
...
console.log('✅ PlanGenerator v16.2 - CORREGIDO: sesionMatriz siempre definida');