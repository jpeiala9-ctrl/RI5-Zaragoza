// ============================================================================
// calendar.js - VERSIÓN ÉLITE 2.10 (COMPLETA)
// Mejoras: series con mínimo de repeticiones, ritmo objetivo por distancia,
// fuerza visible con una sola F, progresión sin taper, máximos realistas.
// ============================================================================
...
const PlanGenerator = {
  ...
  agregarFuerzaASesion(sesion) {
    ...
    // No modificamos sesion.letra aquí; se hará en la visualización.
  },
...
console.log('✅ PlanGenerator v16.10 - Corrección: fuerza muestra una sola F en calendario');