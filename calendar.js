...
// 
// VERSIÓN: 4.0 - CON DISEÑO DE TARJETA IMG_0896 Y CALENDARIO IMG_0895
// ============================================================================
...
const PlanGenerator = {
    ...
    return {
      ...
      estructura: {
        calentamiento: {
          ...
          ritmo: Utils.formatR(ritmoBase * 1.35),
          fc: `${Math.round(fcUmbral * 0.6)}-${Math.round(fcUmbral * 0.7)} lpm`,
          distancia: ((sesion.estructura.calentamiento.duracion) / (ritmoBase * 1.35)).toFixed(2),
        ...
        vueltaCalma: {
          ...
          ritmo: Utils.formatR(ritmoBase * 1.4),
          fc: `${Math.round(fcUmbral * 0.5)}-${Math.round(fcUmbral * 0.6)} lpm`,
          distancia: ((sesion.estructura.vueltaCalma.duracion) / (ritmoBase * 1.4)).toFixed(2),
  ...
  // ==========================================================================
  // ABRIR DETALLE DE SESIÓN (TARJETA IMG_0896 - PERFECTA)
  // ==========================================================================
      ...
      const pasos = [
        {
          ...
          fc: detalle.estructura?.calentamiento?.fc || '128-136 lpm',
        ...
        },
        {
          ...
          ritmo: detalle.ritmoObjetivo || '4:30 min/km',
          fc: detalle.fcObjetivo || '160-170 lpm',
          distancia: detalle.estructura?.principal?.distancia || '8.50',
          texto: detalle.estructura?.principal?.descripcion || 'Trabajo de calidad. Las series se corren a un ritmo rápido, con recuperaciones activas (trote suave) entre ellas. Concéntrate en mantener la técnica y el ritmo objetivo en cada repetición. No salgas demasiado rápido.'
        },
        {
          numero: 3,
          ...
          fc: detalle.estructura?.vueltaCalma?.fc || '110-120 lpm',
...
console.log('✅ PlanGenerator v4.0 - ÉLITE MUNDIAL | Ciencia real | Tarjetas perfectas (IMG_0896) | Calendario IMG_0895');