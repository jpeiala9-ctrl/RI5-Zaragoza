...
// Versión: 2.41 - Exportación .FIT para relojes GPS (fit-encoder)
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== FUNCIÓN DE EXPORTACIÓN .FIT (fit-encoder) ==========
  exportarWorkoutAFIT(sesion) {
    ...
    if (!window.FitEncoder || !window.FitEncoder.Workout) {
      Utils.showToast('Librería FIT no disponible. Recarga la página.', 'error');
      return;
    }

    const { Workout, WorkoutStep } = window.FitEncoder;
...
console.log('✅ PlanGenerator v2.41 - Exportación .FIT para relojes GPS');