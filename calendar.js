...
// Versión: 7.4 - Corregido: visualización de días de semana y respeto estricto de días seleccionados
// ============================================================================
...
const PlanGenerator = {
  ...
  // ==========================================================================
  // CONSTANTES DE PERIODIZACIÓN (sin cambios)
  // ==========================================================================
  FASES: {
  ...
  // ==========================================================================
  // FUNCIONES AUXILIARES DE PERIODIZACIÓN (sin cambios)
  // ==========================================================================
  ...
  // Asignación determinista: solo asigna tipos a los días seleccionados (incluido el largo)
  asignarTiposADias(diasEntreno, diaLargo, tiposSemana) {
    ...
    const tieneDescansoDespues = (dia) => {
      ...
      return !diasEntreno.includes(diaSiguiente);
    };

    // Ordenar los otros días según criterios: primero los que tienen descanso después,
    // y entre ellos los que tengan más descanso consecutivo (contando solo dentro de la semana)
    const contarDescansoConsecutivo = (dia) => {
      ...
      while (true) {
        ...
        if (!diasEntreno.includes(diaActual)) {
          count++;
        } else {
          break;
        }
    ...
    // Verificación: asegurar que solo los días en diasEntreno tienen tipo (el resto quedan undefined)
    // Esto ya se cumple porque solo asignamos a diaLargo y otrosDias.
    return tiposPorDia;
  },
  ...
  // ==========================================================================
  // CREACIÓN DE SESIONES (sin cambios relevantes)
  // ==========================================================================
  ...
  renderizarPagina(sesiones) {
    ...
    // Convertir a nuestro sistema: lunes=1, domingo=7
    let offset = diaSem === 0 ? 6 : diaSem - 1; // offset para que lunes sea 0
    ...
    while (sesionIndex < finPagina) {
      ...
      // Mostrar letra del día de la semana (sesion.diaSemana va de 1 a 7)
  ...
  // ==========================================================================
  // GESTIÓN DE PLANES GUARDADOS (sin cambios)
  // ==========================================================================
...
console.log('✅ PlanGenerator v7.4 - Días de semana visibles y respeto estricto de selección');