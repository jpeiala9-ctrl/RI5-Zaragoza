// ==================== calendar.js - VERSIÓN COMPLETA (v2.72) ====================
// Un solo checkbox (verde/naranja automático), wake lock, mensaje pantalla encendida
// ============================================================================
  ...
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      checkbox.onchange = async (e) => {
        ...
        if (e.target.checked) {
          if (lastRouteData && lastRouteData.porcentaje !== undefined && lastRouteData.porcentaje <= 10) {
            ...
            Utils.showToast(`✅ Sesión marcada (${lastRouteData.porcentaje.toFixed(1)}% diferencia)`, 'success');
          } else {
          ...
          Utils.showToast('📝 Sesión desmarcada', 'success');
        }
      };
      ...
      if (!realizada) {
        ...
        startBtn.innerHTML = '📍 Iniciar Grabación GPS';
...
console.log('✅ PlanGenerator v2.72 - Un solo checkbox (verde/naranja automático), sin botón adicional, wake lock');