...
// Versión: 2.64 - Modal de detalle de sesiones de fuerza: muestra tiempo y calorías,
//                oculta distancia, TSS y zona.
// ============================================================================
...
const PlanGenerator = {
  ...
  // ==================== FUNCIÓN MODIFICADA: abrirDetalleSesion ====================
  // Ahora para sesiones de fuerza muestra tiempo y calorías, y oculta distancia, TSS y zona.
  ...
  async limpiarMuroGlobal() {
    // Esta función ya no borra nada (se mantiene por compatibilidad)
    return;
  },
...
console.log('✅ PlanGenerator v2.64 - Modal de detalle de fuerza: muestra tiempo y calorías, oculta distancia y TSS');