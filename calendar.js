// ==================== calendar.js - VERSIÓN CORREGIDA (PERSISTENCIA NARANJA) ====================
// GPS con botón COMENZAR, marcadores sutiles, CartoDB Voyager, y corrección de persistencia de sesiones forzadas
// ============================================================================
...
const PlanGenerator = {
  ...
  async marcarSesionForzada(diaIndex, realizada, routeData = null, skipToast = false) {
    ...
    try {
      ...
      // Verificación extra para asegurar que se guardó
      ...
      checkbox.onchange = async (e) => {
        ...
        if (e.target.checked) {
          if (lastRouteData && lastRouteData.porcentaje !== undefined && lastRouteData.porcentaje <= 10) {
            ...
            // Esperamos medio segundo para asegurar que Firestore termina la escritura
...
console.log('✅ PlanGenerator v2.77 final - Corrección definitiva de persistencia de sesiones forzadas');