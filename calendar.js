...
// Versión: 2.68 - GPS sin cuenta atrás, wake lock, km reales en verde, planificados en naranja
// ============================================================================
...
const PlanGenerator = {
  ...
  // ========== ABRIR DETALLE CON GPS MEJORADO Y WAKE LOCK ==========
  abrirDetalleSesion(sesion, diaIndex) {
    ...
    if (sesion.tipo !== 'descanso' && sesion.detalle) {
      ...
      if (!realizada) {
        ...
        gpsControls.style.cssText = 'display: flex; gap: 12px; margin: 16px 0; justify-content: center; flex-wrap: wrap;';
        ...
        startBtn.onclick = async () => {
          ...
          stopBtn.innerHTML = 'TERMINAR SESIÓN';
          stopBtn.onclick = async () => {
            ...
            if (porcentaje <= 10) {
              ...
              if (!forceButtonCreated) {
                ...
                forceBtn.style.cssText = 'width: auto; background: #FF9800; border-color: #FF9800; color: var(--bg-primary);';
...
console.log('✅ PlanGenerator v2.68 - GPS sin cuenta atrás, wake lock, km reales en verde, planificados en naranja');