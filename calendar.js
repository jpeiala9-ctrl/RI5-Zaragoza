// ============================================================================
// calendar.js - VERSIÓN FINAL
// Respeta días marcados, rellena días previos como completados
// ============================================================================
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      // ===== GENERAR PLAN REAL (DESDE FECHA INICIO) =====
      const planCompleto = [];
      ...
      const diasDesdeLunes = diaSemanaInicio === 0 ? 6 : diaSemanaInicio - 1;
  ...
  // ==========================================================================
  // RENDERIZADO DE PÁGINA - RESPETA DÍAS POR COLUMNA
  // ==========================================================================
  renderizarPagina(sesiones) {
    ...
    // Colocar cada sesión en su posición basada en diaSemana
    for (let i = inicioPagina; i < finPagina; i++) {
      const sesion = sesiones[i];
      if (!sesion) continue;
      
      // Calcular semana relativa dentro de la página
      const semanaRelativa = Math.floor((sesion.diaGlobal - 1 - inicioPagina) / 7);
      if (semanaRelativa < 0 || semanaRelativa >= semanasPorPagina) continue;
      
      // Posición = semanaRelativa * 7 + (diaSemana - 1)
      const pos = semanaRelativa * 7 + (sesion.diaSemana - 1);
...
console.log('✅ PlanGenerator v11.0 - DEFINITIVO: días respetados, previos completados');