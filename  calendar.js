// ============================================================================
// calendar.js - VERSIÓN ÉLITE 2.9
// Mejoras: series con mínimo de repeticiones, ritmo objetivo por distancia,
// fuerza visible en calendario, progresión sin taper, máximos realistas.
// ============================================================================
...
const PlanGenerator = {
  ...
  getMaximosPorTipo(tipo, nivel, fase) {
    ...
    // Máximo absoluto para series: 90 minutos
  ...
  obtenerFactorProgresion(semanaEnFase, duracionFase, fase) {
    // No aplicar progresión en taper (ya tiene su propia reducción)
  ...
  agregarFuerzaASesion(sesion) {
    ...
    // Añadir indicador visual en el calendario
    sesion.letra += '+F';
  },
  ...
  async crearSesionDesdeMatriz(sesionBase, esActivo, fase, semanaEnFase, nivel, datos, factorVolumen, factorIntensidad, duracionExacta = null) {
    ...
    // Ritmo objetivo según distancia
    ...
    if (incluirRitmoObjetivo) {
      ...
      switch(tipo) {
        ...
        case 'largo':
          ...
          break;
        case 'series': {
          // ================== SERIES CON MÍNIMO DE REPETICIONES ==================
          ...
          // Mínimo de repeticiones: 4 (3 en taper)
          ...
          // Si no caben las repeticiones mínimas con la distancia actual, reducir distancia
          if (repeticiones < minReps && partePrincipal > 0) {
            // Calcular tiempo necesario para minReps con la misma relación descanso
            ...
            // Recalcular con la nueva distancia
          ...
          // Si aún no caben (caso extremo), reducir recuperación
          ...
          if (tiempoExtra < 0) {
            // Reducir recuperación hasta que quepa
    ...
    // Precalcular métricas para feed
  ...
  // ==========================================================================
  // RESTO DE FUNCIONES (sin cambios, se mantienen igual)
  // ==========================================================================
...
console.log('✅ PlanGenerator v16.9 - Mejoras: series con mínimo de repeticiones, ritmo objetivo por distancia, fuerza visible, progresión sin taper');