// ==================== group-sessions.js ====================
// Versión: 1.3 - Corregido: errores en envío, selector de amigos y aceptar/rechazar
// ====================

const GroupSessions = {
  // ============================================================
  // 1. CREAR INVITACIÓN (1 o más amigos) - CORREGIDO
  // ============================================================
  async invitar(fromUserId, toUserIds, sesion, diaGlobal = null) {
    ...
    // Si no se pudo enviar ningún mensaje, pero la sesión se creó, no lanzamos error
    // porque el creador puede compartir el enlace manualmente.
    if (errorEnMensajes && Object.keys(messageIds).length === 0) {
      console.warn('No se pudo enviar mensajes a los invitados, pero la sesión se creó correctamente.');
    }
  ...
  // ============================================================
  // 9. SELECTOR DE AMIGOS (CORREGIDO - carga inmediata)
  // ============================================================
  async mostrarSelectorAmigos(sesion, diaGlobal) {
    return new Promise((resolve) => {
      ...
      // Cargar amigos directamente desde Storage y construir la lista manualmente
      // para no depender del DOM de Friends
        ...
        if (friendIds.length === 0) {
          ...
          (async () => {
            try {
              ...
              // Añadir evento de click a cada item para toggle checkbox
...
console.log('✅ GroupSessions v1.3 - Correcciones en envío, selector y aceptar/rechazar');