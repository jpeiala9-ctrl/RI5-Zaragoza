// ==================== group-sessions.js ====================
// Versión: 1.4 - Corregido: chatMessageIds en reglas y mejor manejo de errores
// ====================

const GroupSessions = {
  // ============================================================
  // 1. CREAR INVITACIÓN (CORREGIDO: chatMessageIds)
  // ============================================================
  async invitar(fromUserId, toUserIds, sesion, diaGlobal = null) {
    ...
    const data = {
      ...
      isChallenge: false,
      challengeId: null,
      chatMessageIds: {} // <-- campo correcto (plural)
    };

    // Guardar el documento principal
    await ref.set(data);

    // Enviar mensajes especiales
    ...
    // Actualizar los IDs de mensaje (si hay alguno)
    if (Object.keys(messageIds).length > 0) {
      try {
        ...
        // No lanzamos error para que la invitación no falle
      }
    }
...
console.log('✅ GroupSessions v1.4 - Corregido: chatMessageIds en reglas y mejor manejo de errores');