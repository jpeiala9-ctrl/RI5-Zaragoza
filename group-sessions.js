// ==================== group-sessions.js ====================
// Versión: 1.5 - Recarga automática del tab GRUPO al aceptar/rechazar
// ====================
...
const GroupSessions = {
  ...
  // ============================================================
  // 8. RECARGAR TAB GRUPO (si está activo)
  // ============================================================
  _recargarTabGrupo() {
...
console.log('✅ GroupSessions v1.5 - Recarga automática del tab GRUPO al aceptar/rechazar');